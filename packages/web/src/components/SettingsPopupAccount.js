    ...
    return (
      <div className={tailwind('p-4 md:p-6')}>
        ...
        <div className={tailwind('mt-8 mb-4')}>
          ...
          <p className={tailwind('mt-4 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>If you get started with us, currently we create your Stacks account without username, profile, and data server location. So there is no data stored in the Stacks blockchain and your data server is automatically selected.</p>
