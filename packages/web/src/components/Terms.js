      ...
      <div className="px-4 bg-gray-200 min-h-screen md:px-6 lg:px-8">
        ...
        <section className="pt-12 pb-4">
          <div style={{ borderRadius: '1.5rem' }} className="mx-auto px-4 pt-8 pb-8 w-full max-w-3xl bg-white text-gray-800">
            ...
            <p className="pt-3 leading-relaxed">By accessing the website at <a className="hover:text-black focus:outline-none focus:shadow-outline" href="https://brace.to">https://brace.to</a>, you are agreeing to be bound by these terms of use, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.</p>
            ...
            <p className="pt-3 leading-relaxed">The materials on Brace.to's website are provided on an 'as is' basis. Brace.to makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</p>
            <p className="pt-3 leading-relaxed">Further, Brace.to does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.</p>

            <h2 className="pt-10 text-gray-900 font-semibold">Limitations</h2>
            <p className="pt-3 leading-relaxed">In no event shall Brace.to or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Brace.to's website, even if Brace.to or a Brace.to authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</p>

            <h2 className="pt-10 text-gray-900 font-semibold">Accuracy of materials</h2>
            <p className="pt-3 leading-relaxed">The materials appearing on Brace.to's website could include technical, typographical, or photographic errors. Brace.to does not warrant that any of the materials on its website are accurate, complete or current. Brace.to may make changes to the materials contained on its website at any time without notice. However Brace.to does not make any commitment to update the materials.</p>

            <h2 className="pt-10 text-gray-900 font-semibold">Links</h2>
            <p className="pt-3 leading-relaxed">Brace.to has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by Brace.to of the site. Use of any such linked website is at the user's own risk.</p>

            <h2 className="pt-10 text-gray-900 font-semibold">Modifications</h2>
            <p className="pt-3 leading-relaxed">Brace.to may revise these terms of use for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of use.</p>

            <p className="pt-10 leading-relaxed">If you have any questions regarding any of our terms, please contact us at <a className="hover:text-black focus:outline-none focus:shadow-outline" href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;%73%75%70%70%6F%72%74%40%62%72%61%63%65%2E%74%6F"><span className="e-mail" data-user="troppus" data-website="ot.ecarb"></span></a>.</p>
