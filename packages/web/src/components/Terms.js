      ...
      <div className="px-4 bg-gray-200 min-h-screen md:px-6 lg:px-8">
        ...
        <section className="pt-12 pb-4">
          <div style={{ borderRadius: '1.5rem' }} className="mx-auto px-4 pt-8 pb-8 w-full max-w-3xl bg-white text-gray-800">
            ...
            <p className="pt-3 leading-relaxed">By accessing the website at <a href="https://brace.to">https://brace.to</a>, you are agreeing to be bound by these terms of use, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.</p>
