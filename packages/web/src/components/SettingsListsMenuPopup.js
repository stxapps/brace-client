...
const SettingsListsMenuPopup = () => {
  ...
  const buttons = (
    <div className="py-1">
      <button onClick={onEditBtnClick} className="group w-full flex items-center px-4 py-3 text-sm text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 sm:hidden" role="menuitem">
        <svg className="mr-3 h-4 w-4 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500" viewBox="0 0 14 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <button onClick={onMoveUpBtnClick} className="group w-full flex items-center px-4 py-3 text-sm text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 lg:hidden" role="menuitem">
        <svg className="mr-3 w-4 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500" viewBox="0 0 14 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <button onClick={onMoveDownBtnClick} className="group w-full flex items-center px-4 py-3 text-sm text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 lg:hidden" role="menuitem">
        <svg className="mr-3 w-4 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500" viewBox="0 0 14 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <button onClick={onMoveToBtnClick} className="group w-full flex items-center px-4 py-3 text-sm text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">
        <svg className="mr-3 w-4 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500" viewBox="0 0 16 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      {![MY_LIST, TRASH, ARCHIVE].includes(selectingListName) && <button onClick={onDeleteBtnClick} className="group w-full flex items-center px-4 py-3 text-sm text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">
        <svg className="mr-3 w-4 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500" viewBox="0 0 14 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  let popupClassNames = 'fixed w-36 rounded-lg shadow-xl bg-white overflow-auto ring-1 ring-black ring-opacity-5 z-41';
  let panel;
  if (popupSize) {
    ...
    panel = (
      <div key="SLMP_popup" ref={popup} style={{ top: safeAreaHeight, left: safeAreaWidth }} className={popupClassNames} role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
        {buttons}
      </div>
    );
  }
