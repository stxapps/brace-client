    ...
    return (
      <React.Fragment>
        ...
        <div className="mx-auto px-4 pt-16 pb-4 w-full max-w-3xl bg-white text-gray-500 md:px-6 lg:px-8">
          <h1 className="text-3xl text-gray-900 font-extrabold sm:text-4xl">Support</h1>
          <p className="mt-6">Please feel free to contact us.</p>
          <div className="mx-auto w-full max-w-md">
            <a className="mt-20 pt-2 block rounded group focus:outline-none focus:ring" href="https://twitter.com/bracedotto" target="_blank" rel="noreferrer">
              <svg className="mx-auto w-12 text-gray-400 group-hover:text-gray-500" viewBox="0 0 40 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mt-2 text-gray-500 text-center group-hover:text-gray-600">Twitter</p>
            </a>
            <a className="mt-10 pt-2 block rounded group focus:outline-none focus:ring" href="https://github.com/bracedotto/brace-client/issues" target="_blank" rel="noreferrer">
              <svg className="mx-auto w-12 text-gray-400 group-hover:text-gray-500" viewBox="0 0 33 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mt-2 text-gray-500 text-center group-hover:text-gray-600">Github</p>
            </a>
            <a className="mt-10 pt-2 block rounded group focus:outline-none focus:ring" href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#64;&#98;&#114;&#97;&#99;&#101;&#46;&#116;&#111;">
              <svg className="mx-auto w-12 text-gray-400 group-hover:text-gray-500" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 12.713l-11.985-9.713h23.971l-11.986 9.713zm-5.425-1.822l-6.575-5.329v12.501l6.575-7.172zm10.85 0l6.575 7.172v-12.501l-6.575 5.329zm-1.557 1.261l-3.868 3.135-3.868-3.135-8.11 8.848h23.956l-8.11-8.848z" />
              </svg>
              <p className="mt-1 text-gray-500 text-center group-hover:text-gray-600">Email</p>
            </a>
          </div>
