      ...
      <div className="px-4 bg-gray-200 min-h-screen md:px-6 lg:px-8">
        ...
        <section className="pt-12 pb-4">
          <div style={{ borderRadius: '1.5rem' }} className="mx-auto px-4 pt-8 pb-8 w-full max-w-md bg-white">
            ...
            <a className="mt-10 block focus:outline-none focus:shadow-outline" href="https://twitter.com/bracedotto">
              <svg className="mx-auto w-12 text-gray-600" viewBox="0 0 40 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mt-2 text-gray-700 font-medium text-center">Twitter</p>
            </a>
            <a className="mt-10 block focus:outline-none focus:shadow-outline" href="https://github.com/bracedotto/brace-client/issues">
              <svg className="mx-auto w-12 text-gray-600" viewBox="0 0 33 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mt-2 text-gray-700 font-medium text-center">Github</p>
            </a>
            <a className="mt-10 block focus:outline-none focus:shadow-outline" href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;%73%75%70%70%6F%72%74%40%62%72%61%63%65%2E%74%6F">
              <svg className="mx-auto w-12 text-gray-600" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 12.713l-11.985-9.713h23.971l-11.986 9.713zm-5.425-1.822l-6.575-5.329v12.501l6.575-7.172zm10.85 0l6.575 7.172v-12.501l-6.575 5.329zm-1.557 1.261l-3.868 3.135-3.868-3.135-8.11 8.848h23.956l-8.11-8.848z" />
              </svg>
              <p className="mt-1 text-gray-700 font-medium text-center">Email</p>
            </a>
            <div className="pt-12 text-right">
              <a className="mt-2 inline-block focus:outline-none focus:shadow-outline" href="/">
                <span className="text-gray-700">Go home</span>
