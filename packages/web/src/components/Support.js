      ...
      <React.Fragment>
        ...
        <div className="mx-auto px-4 pt-16 pb-4 w-full max-w-3xl bg-white text-gray-500 md:px-6 lg:px-8">
          ...
          <div className="mx-auto w-full max-w-md">
            ...
            <a className="mt-10 pt-2 block rounded group focus:outline-none focus:ring" href="https://github.com/stxapps/brace-client/issues" target="_blank" rel="noreferrer">
