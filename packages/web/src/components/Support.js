      ...
      <React.Fragment>
        ...
        <div className="mx-auto px-4 pt-16 pb-4 w-full max-w-3xl bg-white text-gray-500 md:px-6 lg:px-8">
          ...
          <div className="mx-auto w-full max-w-md">
            <a className="mt-8 pt-2 block group focus:outline-none focus:ring" href="https://twitter.com/bracedotto">
              ...
              <p className="mt-2 text-gray-500 font-medium text-center group-hover:text-gray-600">Twitter</p>
            </a>
            <a className="mt-8 pt-2 block group focus:outline-none focus:ring" href="https://github.com/bracedotto/brace-client/issues">
              ...
              <p className="mt-2 text-gray-500 font-medium text-center group-hover:text-gray-600">Github</p>
            </a>
            <a className="mt-8 pt-2 block group focus:outline-none focus:ring" href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#64;&#98;&#114;&#97;&#99;&#101;&#46;&#116;&#111;">
              ...
              <p className="mt-1 text-gray-500 font-medium text-center group-hover:text-gray-600">Email</p>
            </a>
          </div>
