          ...
          <div style={{ borderRadius: '1.5rem' }} className="mx-auto px-4 pt-8 pb-8 w-full max-w-3xl bg-white text-gray-800">
            ...
            <div className="pt-12 md:flex md:justify-end md:items-center">
              ...
              <p className="mt-4 ml-4 max-w-xl leading-relaxed text-justify hyphens-auto md:mt-0">
                We know that design is very important. Our user interface needs to be slick, intuitive, and beautiful. We use <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://www.figma.com/">Figma</a> to design and <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://tailwindcss.com/">TailwindCSS</a> to style. Many icons and illustrations are from <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://www.heroicons.com/">Heroicons</a>, <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://iconmonstr.com/">iconmonstr</a>, <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://undraw.co/">unDraw.co</a>, <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://loading.io/">Loading.io</a>, and <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://connoratherton.com/loaders">Loaders.css</a>. We learn a lot from Adam Wathan's <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://www.youtube.com/channel/UCy1H38XrN7hi7wHSClfXPqQ">youtube channel</a> and <a className="underline hover:text-black focus:outline-none focus:shadow-outline" href="https://refactoringui.com/">RefactoringUI book</a> from Steve Schoger. We'd like to thank all of them very much.
                  </p>
            </div>
