        ...
        <div className="mx-auto px-4 pt-16 pb-4 w-full max-w-3xl bg-white text-gray-500 md:px-6 lg:px-8">
          ...
          <div className="ml-auto pt-6 max-w-md md:flex md:justify-end md:items-start md:max-w-none">
            ...
            <p className="mx-4 mt-4 leading-7 text-justify hyphens-auto md:mt-0 md:max-w-md">
              Privacy is at our heart. That's why we choose <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://www.stacks.co/">Stacks</a>. Stacks provides tools and libraries for building a website that respects our users' privacy. User identities live in blockchain securely and cannot be locked, banned, or deleted by Brace.to or anyone. All links at Brace.to are encrypted, no one can see their content. Even Brace.to cannot see what links users save. Also, users can setup their own server to save their links if they want.
              </p>
          </div>
          <div className="pt-6 max-w-xl">
            ...
            <p className="leading-7 text-justify hyphens-auto">
              Brace.to is open sourced and published at <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/bracedotto">Github.com</a>. It's built with many tools and libraries. The list is not exhausive and continue to grow: <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://reactjs.org/">React</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://create-react-app.dev/">Create React App</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://react-redux.js.org/">React Redux</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://redux.js.org">Redux</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/reduxjs/redux-thunk">Redux Thunk</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://redux-loop.js.org/">Redux Loop</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/rt2zz/redux-persist">Redux Persist</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/redux-offline/redux-offline">Redux Offline</a>, and <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://reactnative.dev/">React Native</a>. Brace.to cannot go this far without these tools and libraries. Really appreciate.
                </p>
          </div>
          <div className="pt-6 md:flex md:justify-end md:items-center">
            ...
            <p className="mt-4 ml-4 max-w-xl leading-7 text-justify hyphens-auto md:mt-0">
              We know that design is very important. Our user interface needs to be slick, intuitive, and beautiful. We use <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://www.figma.com/">Figma</a> to design and <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://tailwindcss.com/">TailwindCSS</a> to style. Many icons and illustrations are from <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://www.heroicons.com/">Heroicons</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://iconmonstr.com/">iconmonstr</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://undraw.co/">unDraw.co</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://loading.io/">Loading.io</a>, and <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://connoratherton.com/loaders">Loaders.css</a>. We learn a lot from Adam Wathan's <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://www.youtube.com/channel/UCy1H38XrN7hi7wHSClfXPqQ">youtube channel</a> and <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://refactoringui.com/">RefactoringUI book</a> from Steve Schoger. We'd like to thank all of them very much.
              </p>
          </div>
