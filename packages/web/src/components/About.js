          ...
          <div style={{ borderRadius: '1.5rem' }} className="mx-auto px-4 pt-8 pb-8 w-full max-w-3xl bg-white text-gray-800">
            ...
            <div className="ml-auto pt-12 max-w-md md:flex md:justify-end md:items-start md:max-w-none">
              ...
              <p className="mx-4 mt-4 leading-relaxed text-justify hyphens-auto md:mt-0 md:max-w-md">
                Privacy is at our heart. That's why we choose <a className="underline" href="https://blockstack.org/">Blockstack</a>. Blockstack provides tools and libraries for building a website that respects our users' privacy. User identities live in blockchain securely and cannot be locked, banned, or deleted by Brace.to or anyone. All links at Brace.to is encrypted, no one can see their content. Brace.to cannot see what links users save. Also, users can setup their own server to save links if they want.
              </p>
            </div>
            <div className="pt-12 max-w-xl">
              ...
              <p className="leading-relaxed text-justify hyphens-auto">
                Brace.to is open sourced and published at <a className="underline" href="https://github.com/bracedotto">Github.com</a>. It's built with many tools and libraries. The list is not exhausive and continue to grow: <a className="underline" href="https://reactjs.org/">React</a>, <a className="underline" href="https://create-react-app.dev/">Create React App</a>, <a className="underline" href="https://react-redux.js.org/">React Redux</a>, <a className="underline" href="https://redux.js.org">Redux</a>, <a className="underline" href="https://github.com/reduxjs/redux-thunk">Redux Thunk</a>, <a className="underline" href="https://redux-loop.js.org/">Redux Loop</a>, <a className="underline" href="https://github.com/rt2zz/redux-persist">Redux Persist</a>, <a className="underline" href="https://github.com/redux-offline/redux-offline">Redux Offline</a>, and <a className="underline" href="https://tsuyoshiwada.github.io/react-stack-grid">React Stack Grid</a>. Brace.to cannot go this far without these tools and libraries. Really appreciate.
                </p>
            </div>
            <div className="pt-12 md:flex md:justify-end md:items-center">
              ...
              <p className="mt-4 ml-4 max-w-xl leading-relaxed text-justify hyphens-auto md:mt-0">
                We know that design is very important. Our user interface needs to be slick, intuitive, and beautiful. We use <a className="underline" href="https://www.figma.com/">Figma</a> to design and <a className="underline" href="https://tailwindcss.com/">TailwindCSS</a> to style. Many icons and illustrations are from <a className="underline" href="https://www.heroicons.com/">Heroicons</a>, <a className="underline" href="https://iconmonstr.com/">iconmonstr</a>, <a className="underline" href="https://undraw.co/">unDraw.co</a>, <a className="underline" href="https://loading.io/">Loading.io</a>, and <a className="underline" href="https://connoratherton.com/loaders">Loaders.css</a>. We learn a lot from Adam Wathan's <a className="underline" href="https://www.youtube.com/channel/UCy1H38XrN7hi7wHSClfXPqQ">youtube channel</a> and <a className="underline" href="https://refactoringui.com/">RefactoringUI book</a> from Steve Schoger. We'd like to thank all of them very much.
                  </p>
            </div>
            ...
            <p className="pt-12 leading-relaxed">
              Brace Team
              <br />
              <a href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;%73%75%70%70%6F%72%74%40%62%72%61%63%65%2E%74%6F">
            ...
            <div className="pt-12 text-right">
              ...
              <br />
              <a className="mt-2 inline-block" href="/">
                <span>Go home</span>
                <svg className="mb-1 ml-1 inline-block w-5 text-gray-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
