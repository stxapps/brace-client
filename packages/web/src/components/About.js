        ...
        <div className="mx-auto px-4 pt-16 pb-4 w-full max-w-3xl bg-white text-gray-500 md:px-6 lg:px-8">
          ...
          <div className="pt-6 max-w-xl">
            ...
            <p className="leading-7 text-justify hyphens-auto">
              Brace.to is open sourced and published at <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/stxapps/brace-client" target="_blank" rel="noreferrer">Github.com</a>. It's built with many tools and libraries. The list is not exhausive and continue to grow: <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://reactjs.org/" target="_blank" rel="noreferrer">React</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://create-react-app.dev/" target="_blank" rel="noreferrer">Create React App</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://react-redux.js.org/" target="_blank" rel="noreferrer">React Redux</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://redux.js.org" target="_blank" rel="noreferrer">Redux</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/reduxjs/redux-thunk" target="_blank" rel="noreferrer">Redux Thunk</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://redux-loop.js.org/" target="_blank" rel="noreferrer">Redux Loop</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/rt2zz/redux-persist" target="_blank" rel="noreferrer">Redux Persist</a>, <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://github.com/redux-offline/redux-offline" target="_blank" rel="noreferrer">Redux Offline</a>, and <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="https://reactnative.dev/" target="_blank" rel="noreferrer">React Native</a>. Brace.to cannot go this far without these tools and libraries. Really appreciate.
                </p>
          </div>
