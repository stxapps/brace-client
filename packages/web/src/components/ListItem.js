...
const ListItem = (props) => {
        ...
        <div className={tailwind('absolute inset-0 flex bg-transparent p-1')}>
          ...
          <div className={tailwind('flex flex-shrink-0 flex-grow-0')}>
            <button onClick={onRetryRetryBtnClick} className={tailwind('group focus:outline-none')}>
              <div className={tailwind('rounded-full border border-white bg-white px-3 py-1 text-sm font-medium text-gray-500 group-hover:bg-gray-700 group-hover:text-gray-50 group-focus:ring group-focus:ring-blue-300')}>
                Retry
              </div>
            </button>
            <button onClick={onRetryCancelBtnClick} className={tailwind('group focus:outline-none sm:px-2')}>
              <div className={tailwind('m-0.5 rounded p-0.5 text-sm font-medium text-gray-100 group-hover:bg-gray-100 group-hover:text-gray-500 group-focus:ring group-focus:ring-blue-300')}>
                Cancel
              </div>
            </button>
          </div>
  ...
  const renderBusy = () => {
    ...
    return (
      <div className={tailwind('absolute top-0 right-0 h-10 w-10 overflow-hidden bg-transparent')}>
        <div className={tailwind('relative h-10 w-10 translate-x-1/2 -translate-y-1/2 rotate-45 transform overflow-hidden bg-gray-600')}>
  ...
  return (
    <li className={tailwind('relative bg-white')}>
