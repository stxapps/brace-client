  ...
  renderDiedAdding() {
    ...
    const content = (
      <React.Fragment>
        ...
        <p className="mx-auto mt-5 w-full max-w-xs text-base text-gray-500 text-left leading-relaxed sm:text-center">Please wait a moment and try again. If the problem persists, please <a className="underline rounded hover:text-gray-600 focus:outline-none focus:ring" href={'/' + HASH_SUPPORT}>contact us
