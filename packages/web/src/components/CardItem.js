...
class CardItem extends React.Component {
  ...
  renderBusy() {
    ...
    return (
      <div className={tailwind('absolute top-0 right-0 h-16 w-16 overflow-hidden bg-transparent')}>
        <div className={tailwind('relative h-16 w-16 translate-x-1/2 -translate-y-1/2 rotate-45 transform overflow-hidden bg-white')}>
          <svg style={svgStyle} className={tailwind('relative h-6 w-6 -translate-x-1/2 -translate-y-full -rotate-45 transform text-gray-700')} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  renderPin() {
    ...
    return (
      <div className={tailwind('absolute top-0 left-0 h-16 w-16 overflow-hidden bg-transparent')}>
        <div className={tailwind('relative h-16 w-16 -translate-x-1/2 -translate-y-1/2 rotate-45 transform overflow-hidden bg-white')}>
          <svg style={svgStyle} className={tailwind('relative h-4 w-4 -translate-x-1/2 -translate-y-full -rotate-45 transform text-gray-500')} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  render() {
    ...
    return (
      <div className={tailwind('relative mx-auto max-w-md overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm sm:max-w-none')}>
