...
class SettingsPopupMisc extends React.PureComponent {
    ...
    if (updateSettingsProgress.status === DIED_UPDATING) {
      return (
        <div className="absolute top-0 inset-x-0 flex justify-center items-start">
          <div className="m-4 p-4 bg-red-100 rounded-md shadow-lg">
            <div className="flex">
  ...
  render() {
    ...
    const doExtractBtnClassNames = doExtractContents ? 'bg-blue-600' : 'bg-gray-200';
    const doExtractBtnInnerClassNames = doExtractContents ? 'translate-x-5' : 'translate-x-0';

    const doDeleteBtnClassNames = doDeleteOldLinksInTrash ? 'bg-blue-600' : 'bg-gray-200';
    ...
    return (
      <div className="p-4 relative md:p-6 md:pt-4 lg:p-8 lg:pt-6">
        <div className="border-b border-gray-400 md:hidden">
          ...
          <h3 className="pb-2 text-2xl text-gray-800 font-medium leading-none">Misc.</h3>
        </div>
        <div className="mt-6 flex items-center justify-between space-x-4 md:mt-0">
          <div className="flex flex-col">
            <h4 id="link-previews-option-label" className="text-xl text-gray-800 font-medium leading-none">Link Previews</h4>
        ...
        <div className="mt-8 flex items-center justify-between space-x-4">
          <div className="flex flex-col">
            <h4 id="auto-delete-option-label" className="text-xl text-gray-800 font-medium leading-none">Auto Cleanup</h4>
