  ...
  return (
    <div className={tailwind('p-4 md:p-6')}>
      <div className={tailwind('border-b border-gray-200 md:hidden')}>
        ...
        <h3 className={tailwind('pb-2 text-xl font-medium leading-none text-gray-800')}>About</h3>
      </div>
      <div className={tailwind('mt-6 md:mt-0')}>
        <img className={tailwind('hidden h-7 md:block')} src={shortLogo} alt="Brace logo" />
        <div className={tailwind('pt-1 md:pt-10')}>
          <a className={tailwind('block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring md:inline')} href={'/' + HASH_LANDING} target="_blank" rel="noreferrer">Home page</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_LANDING_HOW} target="_blank" rel="noreferrer">How to</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">Mobile apps</a>
        </div>
        <div className={tailwind('pt-12 text-left md:pt-10')}>
          <a className={tailwind('block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring md:inline')} href={'/' + HASH_ABOUT} target="_blank" rel="noreferrer">About</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_TERMS} target="_blank" rel="noreferrer">Terms</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_PRIVACY} target="_blank" rel="noreferrer">Privacy</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">Support</a>
        </div>
        <div className={tailwind('flex items-center justify-start pt-16 md:pt-16')}>
          <a className={tailwind('rounded focus:outline-none focus:ring')} href="https://twitter.com/bracedotto" target="_blank" rel="noreferrer">
          ...
          <a className={tailwind('ml-8 rounded focus:outline-none focus:ring')} href="https://github.com/stxapps/brace-client" target="_blank" rel="noreferrer">
