  ...
  return (
    <div className="p-4 md:p-6">
      <div className="border-b border-gray-200 md:hidden">
        ...
        <h3 className="pb-2 text-xl text-gray-800 font-medium leading-none">About</h3>
      </div>
      <div className="mt-6 md:mt-0">
        ...
        <div className="pt-12 text-left md:pt-10">
          <a className="block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring md:inline" href={'/' + HASH_ABOUT} target="_blank" rel="noreferrer">About</a>
          <a className="mt-4 block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring md:inline md:mt-0 md:ml-14" href={'/' + HASH_TERMS} target="_blank" rel="noreferrer">Terms</a>
          <a className="mt-4 block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring md:inline md:mt-0 md:ml-14" href={'/' + HASH_PRIVACY} target="_blank" rel="noreferrer">Privacy</a>
          <a className="mt-4 block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring md:inline md:mt-0 md:ml-14" href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">Support</a>
        </div>
        <div className="pt-16 flex justify-start items-center md:pt-16">
          <a className="rounded focus:outline-none focus:ring" href="https://twitter.com/bracedotto" target="_blank" rel="noreferrer">
            <svg style={{ width: '2.125rem' }} className="my-0.5 text-gray-400 hover:text-gray-500" viewBox="0 0 40 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a className="ml-8 rounded focus:outline-none focus:ring" href="https://github.com/stxapps/brace-client" target="_blank" rel="noreferrer">
        ...
        <div className="pt-16 lg:flex lg:justify-between">
