  ...
  return (
    <div className={tailwind('p-4 md:p-6')}>
      ...
      <div className={tailwind('mt-6 md:mt-0')}>
        <img className={tailwind('hidden h-7 blk:h-9 md:block')} src={themeMode === BLK_MODE ? shortLogoBlk : shortLogo} alt="Brace logo" />
        <div className={tailwind('pt-1 md:pt-10')}>
          <a className={tailwind('block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring blk:text-gray-400 blk:hover:text-white md:inline')} href={'/' + HASH_LANDING} target="_blank" rel="noreferrer">Home page</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring blk:text-gray-400 blk:hover:text-white md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_LANDING_HOW} target="_blank" rel="noreferrer">How to</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring blk:text-gray-400 blk:hover:text-white md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">Mobile apps</a>
        </div>
        ...
        <div className={tailwind('flex items-center justify-start pt-16 md:pt-16')}>
          <a className={tailwind('rounded focus:outline-none focus:ring')} href="https://twitter.com/bracedotto" target="_blank" rel="noreferrer">
            <svg style={{ width: '2.125rem' }} className={tailwind('my-0.5 text-gray-400 hover:text-gray-500 blk:text-gray-500 blk:hover:text-gray-400')} viewBox="0 0 40 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a className={tailwind('ml-8 rounded focus:outline-none focus:ring')} href="https://github.com/stxapps/brace-client" target="_blank" rel="noreferrer">
            <svg className={tailwind('w-8 text-gray-400 hover:text-gray-500 blk:text-gray-500 blk:hover:text-gray-400')} viewBox="0 0 33 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={tailwind('pt-16 lg:flex lg:justify-between')}>
          <p className={tailwind('text-left text-base text-gray-400 blk:text-gray-500')}>© 2022 <a className={tailwind('rounded-sm text-gray-400 hover:text-gray-500 focus:outline-none focus:ring blk:text-gray-500 blk:hover:text-gray-400')} href="https://www.stxapps.com" target="_blank" rel="noreferrer">STX Apps Co., Ltd.</a></p>
