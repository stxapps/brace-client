      ...
      <div className={tailwind('mt-5 md:mt-0')}>
        ...
        <div className={tailwind('flex items-center justify-start pt-14')}>
          <a className={tailwind('rounded focus:outline-none focus:ring')} href="https://twitter.com/bracedotto" target="_blank" rel="noreferrer">
            <svg style={{ width: '2.0625rem' }} className={tailwind('my-0.5 text-gray-400 hover:text-gray-500 blk:text-gray-500 blk:hover:text-gray-400')} viewBox="0 0 40 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a className={tailwind('ml-8 rounded focus:outline-none focus:ring')} href="https://www.threads.net/@brace.to" target="_blank" rel="noreferrer">
            <svg className={tailwind('w-8 text-gray-400 hover:text-gray-500 blk:text-gray-500 blk:hover:text-gray-400')} viewBox="0 0 192 192" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
