  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className={`px-4 pt-6 pb-6 fixed inset-x-0 bottom-0 bg-white rounded-t-lg shadow-xl transform ${!isAddPopupShown ? 'translate-y-full' : ''} ring-1 ring-black ring-opacity-5 z-41`}>
          <div className="flex">
