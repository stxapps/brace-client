...
const LockPanel = (props) => {
  ...
  return (
    <div className={tailwind('fixed inset-0 bg-white overflow-y-auto blk:bg-gray-900')}>
      <div style={canvasStyle}>
        <div style={style} className={tailwind('mx-auto max-w-6xl px-4 md:px-6 lg:px-8')}>
          <div className={tailwind('py-6 md:py-10')}>
            <button onClick={onLockBtnClick} className={tailwind('group mx-auto py-6 block w-full max-w-sm focus:outline-none')}>
