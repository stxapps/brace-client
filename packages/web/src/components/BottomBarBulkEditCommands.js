        ...
        <div className="relative flex justify-evenly w-full h-full">
          {isArchiveBtnShown && <div className="p-1 w-full h-full min-w-0">
            <button onClick={this.onBulkEditArchiveBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg className="w-6 h-6 text-gray-400 group-hover:text-gray-500" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="p-1 w-full h-full">
            <button onClick={this.onBulkEditCancelBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg style={{ width: '1.625rem' }} className="text-gray-400 group-hover:text-gray-500" viewBox="0 0 28 28" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
