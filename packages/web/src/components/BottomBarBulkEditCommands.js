          ...
          <div className="mx-4 mb-3 p-4 bg-red-50 rounded-md shadow-lg">
            <div className="flex">
              ...
              <div className="ml-3 mt-0.5">
                <h3 className="text-sm text-red-800 text-left leading-5">Please select item(s) first before continuing.</h3>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <React.Fragment>
        <div className="relative flex justify-evenly w-full h-full">
          {isArchiveBtnShown && <div className="p-1 w-full h-full min-w-0">
            <button onClick={this.onBulkEditArchiveBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg className="w-6 h-6 text-gray-500 group-hover:text-gray-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div style={{ marginTop: '0.125rem' }} className="w-full text-xs text-gray-500 leading-4 truncate group-hover:text-gray-600">{getListNameDisplayName(ARCHIVE, listNameMap)}</div>
            </button>
          </div>}
          {isRemoveBtnShown && <div className="p-1 w-full h-full">
            <button onClick={this.onBulkEditRemoveBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg className="w-6 h-6 text-gray-500 group-hover:text-gray-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div style={{ marginTop: '0.125rem' }} className="text-xs text-gray-500 leading-4 group-hover:text-gray-600">Remove</div>
            </button>
          </div>}
          {isRestoreBtnShown && <div className="p-1 w-full h-full">
            <button onClick={this.onBulkEditRestoreBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg className="w-6 h-6 text-gray-500 group-hover:text-gray-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div style={{ marginTop: '0.125rem' }} className="text-xs text-gray-500 leading-4 group-hover:text-gray-600">Restore</div>
            </button>
          </div>}
          {isDeleteBtnShown && <div className="p-1 w-full h-full min-w-0">
            <button onClick={this.onBulkEditDeleteBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
              ...
              <div style={{ marginTop: '0.125rem' }} className="w-full text-xs text-gray-500 leading-4 truncate group-hover:text-gray-600">Permanently Delete</div>
            </button>
          </div>}
          {isMoveToBtnShown && <div className="p-1 w-full h-full">
            <button onClick={this.onBulkEditMoveToBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              ...
              <div style={{ marginTop: '0.0625rem' }} className="text-xs text-gray-500 leading-4 group-hover:text-gray-600">Move to...</div>
            </button>
          </div>}
          <div className="p-1 w-full h-full">
            <button onClick={this.onBulkEditCancelBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg style={{ width: '1.625rem' }} className="text-gray-500 group-hover:text-gray-600" viewBox="0 0 28 28" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-xs text-gray-500 leading-4 group-hover:text-gray-600">Cancel</div>
            </button>
          </div>
