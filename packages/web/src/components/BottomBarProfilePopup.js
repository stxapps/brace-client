  ...
  render() {
    ...
    return (
      <AnimatePresence key="AnimatePresence_BB_ProfilePopup">
        ...
        <motion.div key="BB_ProfilePopup_menuPopup" className="pt-4 pb-4 fixed inset-x-0 bottom-0 bg-white border border-gray-100 rounded-t-lg shadow-xl z-41" variants={bModalFMV} initial="hidden" animate="visible" exit="hidden">
