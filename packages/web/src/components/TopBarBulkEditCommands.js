        ...
        <div className="relative flex justify-end items-center">
          {isArchiveBtnShown && <div className="relative ml-4">
            <button onClick={this.onBulkEditArchiveBtnClick} className={`group focus:outline-none-outer`}>
              <div style={btnStyle} className="px-3 flex justify-center items-center border border-gray-700 rounded-full shadow-sm hover:border-gray-900 group-hover:text-gray-900 active:bg-gray-200 focus:shadow-outline-inner">
