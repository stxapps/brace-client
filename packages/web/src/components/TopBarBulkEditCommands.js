      ...
      <div className="relative flex justify-end items-center">
        {isArchiveBtnShown && <div className="relative ml-4">
          <button onClick={this.onBulkEditArchiveBtnClick} className={`group focus:outline-none`}>
            <div style={btnStyle} className="flex justify-center items-center bg-white border border-gray-400 rounded-full group-hover:border-gray-500 group-focus:ring">
