          ...
          <div className="mt-3 ml-4 p-4 bg-red-50 rounded-md shadow-lg">
            <div className="flex">
              ...
              <div className="ml-3 mt-0.5">
                <h3 className="text-sm text-red-800 text-left leading-5">Please select item(s) below first before continuing.</h3>
              </div>
            </div>
          </div>
        </motion.div>
    ...
    return (
      <div className="relative flex justify-end items-center">
        {isArchiveBtnShown && <div className="relative ml-4">
          <button onClick={this.onBulkEditArchiveBtnClick} className={`group focus:outline-none`}>
            <div style={btnStyle} className="flex justify-center items-center bg-white border border-gray-400 rounded-full shadow-sm group-hover:border-gray-500 group-focus:ring">
              ...
              <span className="ml-1 max-w-16 text-sm text-gray-500 truncate group-hover:text-gray-600">{getListNameDisplayName(ARCHIVE, listNameMap)}</span>
            </div>
          </button>
        </div>}
        {isRemoveBtnShown && <div className="relative ml-4">
          <button onClick={this.onBulkEditRemoveBtnClick} className={`group focus:outline-none`}>
            <div style={btnStyle} className="flex justify-center items-center bg-white border border-gray-400 rounded-full shadow-sm group-hover:border-gray-500 group-focus:ring">
              <svg style={svgStyle} className="text-gray-500 group-hover:text-gray-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="ml-1 text-sm text-gray-500 group-hover:text-gray-600">Remove</span>
            </div>
          </button>
        </div>}
        {isRestoreBtnShown && <div className="relative ml-4">
          <button onClick={this.onBulkEditRestoreBtnClick} className={`group focus:outline-none`}>
            <div style={btnStyle} className="flex justify-center items-center bg-white border border-gray-400 rounded-full shadow-sm group-hover:border-gray-500 group-focus:ring">
              <svg style={svgStyle} className="text-gray-500 group-hover:text-gray-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="ml-1 text-sm text-gray-500 group-hover:text-gray-600">Restore</span>
            </div>
          </button>
        </div>}
        {isDeleteBtnShown && <div className="relative ml-4">
          <button onClick={this.onBulkEditDeleteBtnClick} className={`group focus:outline-none`}>
            <div style={btnStyle} className="flex justify-center items-center bg-white border border-gray-400 rounded-full shadow-sm group-hover:border-gray-500 group-focus:ring">
              <svg style={svgStyle} className="text-red-500 group-hover:text-red-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M9 2C8.62123 2 8.27497 2.214 8.10557 2.55279L7.38197 4H4C3.44772 4 3 4.44772 3 5C3 5.55228 3.44772 6 4 6V16C4 17.1046 4.89543 18 6 18H14C15.1046 18 16 17.1046 16 16V6C16.5523 6 17 5.55228 17 5C17 4.44772 16.5523 4 16 4H12.618L11.8944 2.55279C11.725 2.214 11.3788 2 11 2H9ZM7 8C7 7.44772 7.44772 7 8 7C8.55228 7 9 7.44772 9 8V14C9 14.5523 8.55228 15 8 15C7.44772 15 7 14.5523 7 14V8ZM12 7C11.4477 7 11 7.44772 11 8V14C11 14.5523 11.4477 15 12 15C12.5523 15 13 14.5523 13 14V8C13 7.44772 12.5523 7 12 7Z" />
              </svg>
              <span className="ml-1 text-sm text-gray-500 group-hover:text-gray-600">Permanently Delete</span>
            </div>
          </button>
        </div>}
        {isMoveToBtnShown && <div className="relative ml-4">
          <button onClick={this.onBulkEditMoveToBtnClick} className={`group focus:outline-none`}>
            <div style={btnStyle} className="flex justify-center items-center bg-white border border-gray-400 rounded-full shadow-sm group-hover:border-gray-500 group-focus:ring">
              <svg style={svgStyle} className="text-gray-500 group-hover:text-gray-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <button onClick={this.onBulkEditCancelBtnClick} className={`ml-1 w-10 h-10 group focus:outline-none`}>
