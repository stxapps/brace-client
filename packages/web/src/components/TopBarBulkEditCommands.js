      ...
      <div className={tailwind('relative flex items-center justify-end')}>
        {isArchiveBtnShown && <div className={tailwind('relative ml-4')}>
          <button onClick={this.onBulkEditArchiveBtnClick} className={tailwind('group focus:outline-none')}>
            <div style={btnStyle} className={tailwind('flex items-center justify-center rounded-full border border-gray-400 bg-white group-hover:border-gray-500 group-focus:ring blk:border-gray-400 blk:bg-gray-900 blk:hover:border-gray-300')}>
              ...
              <span className={tailwind('ml-1 max-w-16 truncate text-sm text-gray-500 group-hover:text-gray-600 blk:text-gray-300 blk:group-hover:text-gray-200')}>{getListNameDisplayName(ARCHIVE, listNameMap)}</span>
            </div>
          </button>
        </div>}
        {isRemoveBtnShown && <div className={tailwind('relative ml-4')}>
          <button onClick={this.onBulkEditRemoveBtnClick} className={tailwind('group focus:outline-none')}>
            <div style={btnStyle} className={tailwind('flex items-center justify-center rounded-full border border-gray-400 bg-white group-hover:border-gray-500 group-focus:ring blk:border-gray-400 blk:bg-gray-900 blk:hover:border-gray-300')}>
              ...
              <span className={tailwind('ml-1 text-sm text-gray-500 group-hover:text-gray-600 blk:text-gray-300 blk:group-hover:text-gray-200')}>Remove</span>
            </div>
          </button>
        </div>}
        {isRestoreBtnShown && <div className={tailwind('relative ml-4')}>
          <button onClick={this.onBulkEditRestoreBtnClick} className={tailwind('group focus:outline-none')}>
            <div style={btnStyle} className={tailwind('flex items-center justify-center rounded-full border border-gray-400 bg-white group-hover:border-gray-500 group-focus:ring blk:border-gray-400 blk:bg-gray-900 blk:hover:border-gray-300')}>
              ...
              <span className={tailwind('ml-1 text-sm text-gray-500 group-hover:text-gray-600 blk:text-gray-300 blk:group-hover:text-gray-200')}>Restore</span>
            </div>
          </button>
        </div>}
        {isDeleteBtnShown && <div className={tailwind('relative ml-4')}>
          <button onClick={this.onBulkEditDeleteBtnClick} className={tailwind('group focus:outline-none')}>
            <div style={btnStyle} className={tailwind('flex items-center justify-center rounded-full border border-gray-400 bg-white group-hover:border-gray-500 group-focus:ring blk:border-gray-400 blk:bg-gray-900 blk:hover:border-gray-300')}>
              <svg style={svgStyle} className={tailwind('text-red-500 group-hover:text-red-600 blk:text-gray-300 blk:group-hover:text-gray-200')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M9 2C8.62123 2 8.27497 2.214 8.10557 2.55279L7.38197 4H4C3.44772 4 3 4.44772 3 5C3 5.55228 3.44772 6 4 6V16C4 17.1046 4.89543 18 6 18H14C15.1046 18 16 17.1046 16 16V6C16.5523 6 17 5.55228 17 5C17 4.44772 16.5523 4 16 4H12.618L11.8944 2.55279C11.725 2.214 11.3788 2 11 2H9ZM7 8C7 7.44772 7.44772 7 8 7C8.55228 7 9 7.44772 9 8V14C9 14.5523 8.55228 15 8 15C7.44772 15 7 14.5523 7 14V8ZM12 7C11.4477 7 11 7.44772 11 8V14C11 14.5523 11.4477 15 12 15C12.5523 15 13 14.5523 13 14V8C13 7.44772 12.5523 7 12 7Z" />
              </svg>
              <span className={tailwind('ml-1 text-sm text-gray-500 group-hover:text-gray-600 blk:text-gray-300 blk:group-hover:text-gray-200')}>Permanently Delete</span>
            </div>
          </button>
        </div>}
        {isMoveToBtnShown && <div className={tailwind('relative ml-4')}>
          <button onClick={this.onBulkEditMoveToBtnClick} className={tailwind('group focus:outline-none')}>
            <div style={btnStyle} className={tailwind('flex items-center justify-center rounded-full border border-gray-400 bg-white group-hover:border-gray-500 group-focus:ring blk:border-gray-400 blk:bg-gray-900 blk:hover:border-gray-300')}>
              ...
              <span className={tailwind('ml-1 text-sm text-gray-500 group-hover:text-gray-600 blk:text-gray-300 blk:group-hover:text-gray-200')}>Move to</span>
            </div>
          </button>
        </div>}
