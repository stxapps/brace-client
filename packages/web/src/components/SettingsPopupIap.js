    ...
    infoText = (
      <React.Fragment>
        <p className="mt-4 text-base text-gray-500 leading-relaxed">
          <svg className="inline-block w-5 text-green-500 mb-1 mr-1" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-green-600">Thank you very much for supporting us.</span> You've unlocked extra feature: pin to the top.
        </p>
        <p className="mt-4 text-base text-gray-500 leading-relaxed">Your subscription will be expired on {getFormattedDate(new Date(purchase.expiryDate))} and it'll be automatically renewed. You can manage your subscription at {appStoreLink}.</p>
      </React.Fragment>
    );
  } else if (purchase.status === NO_RENEW) {
    infoText = (
      <React.Fragment>
        <p className="mt-4 text-base text-gray-500 leading-relaxed">Thank you very much for supporting us. You've unlocked extra feature: pin to the top.</p>
        <p className="mt-4 text-base text-gray-500 leading-relaxed">Your subscription will be expired on {getFormattedDate(new Date(purchase.expiryDate))} and it won't be automatically renewed. If you want to enable automatically renewal, please go to {appStoreLink} to manage your subscription.</p>
      </React.Fragment>
    );
    ...
    refreshPanel = (
      <div className="mt-6">
        <div className="flex items-center">
          ...
          <p className="flex-grow flex-shrink ml-1 text-base text-gray-500">Your subscription is up to date.</p>
        </div>
      </div>
    );
    ...
    actionPanel = (
      <div className="mt-6 mb-4">
        <div className="flex items-center">
          ...
          <p className="flex-grow flex-shrink ml-1 text-base text-gray-500">No purchase found.</p>
        </div>
        <p className="mt-6 text-base text-gray-500 leading-relaxed">Please try to restore purchases in our <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring" href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">Mobile apps</a> where you've made the purchase.</p>
