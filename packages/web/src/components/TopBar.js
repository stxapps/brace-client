...
class TopBar extends React.Component {
  ...
  renderAddPopup() {
    ...
    return (
      <React.Fragment>
        <button onClick={this.onAddCancelBtnClick} tabIndex={-1} className="fixed inset-0 w-full h-full bg-black opacity-50 cursor-default z-40 focus:outline-none"></button>
        <div className="mt-2 px-4 pt-6 pb-6 absolute right-0 w-72 bg-white border border-gray-200 rounded-lg shadow-xl z-41 md:w-96">
          <input onChange={this.onAddInputChange} onKeyPress={this.onAddInputKeyPress} className="px-4 py-2 w-full bg-white text-gray-900 border border-gray-600 rounded-full focus:outline-none focus:shadow-outline" type="text" placeholder="https://" value={url} autoFocus />
  ...
  renderProfilePopup() {
    return (
      <React.Fragment>
        <button onClick={this.onProfileCancelBtnClick} tabIndex={-1} className="fixed inset-0 w-full h-full bg-black opacity-50 cursor-default z-40 focus:outline-none"></button>
    ...
    return (
      <div className="flex justify-end items-center">
        ...
        <div className="relative ml-4 w-48 lg:w-56">
          ...
          <input onChange={this.onSearchInputChange} className="py-1 pl-10 pr-4 block w-full bg-gray-200 text-gray-900 border border-transparent rounded-full focus:outline-none focus:shadow-outline focus:bg-white focus:border-gray-300" type="text" placeholder="Search" value={searchString} />
  ...
  renderSignInBtn() {
    ...
    return (
      <button onClick={() => this.props.signIn()} className="my-px block h-14 focus:outline-none-outer">
