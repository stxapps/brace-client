    ...
    return (
      <React.Fragment>
        ...
        <div className="mt-2 px-4 pt-6 pb-6 absolute right-0 w-72 bg-white border border-gray-200 rounded-lg shadow-xl z-41 md:w-96">
          <input onChange={this.onAddInputChange} onKeyPress={this.onAddInputKeyPress} className="px-4 py-2 w-full bg-white text-gray-900 border border-gray-600 rounded-full focus:outline-none focus:shadow-outline" type="url" placeholder="https://" value={url} autoFocus />
    ...
    return (
      <div className="flex justify-end items-center">
        ...
        <div className="relative ml-4 w-48 lg:w-56">
          ...
          <input onChange={this.onSearchInputChange} className="py-1 pl-10 pr-4 block w-full bg-gray-200 text-gray-900 border border-transparent rounded-full focus:outline-none focus:shadow-outline focus:bg-white focus:border-gray-300" type="search" placeholder="Search" value={searchString} />
