            ...
            <div className={tailwind('relative flex flex-col overflow-hidden rounded-lg bg-white blk:bg-gray-800')} style={{ maxHeight: panelHeight }}>
              <div className={tailwind('relative flex-1 overflow-y-auto overflow-x-hidden px-4 pt-8 pb-4 sm:px-6 sm:pb-6')}>
                ...
                <div className={tailwind([LOCK_ACTION_ADD_LOCK_LIST].includes(lockAction) ? 'pt-1' : 'pt-3.5')}>
                  ...
                  <div className={tailwind('relative mt-1 rounded-md bg-white blk:bg-gray-800')}>
                    <input ref={passwordInput} onChange={onPasswordInputChange} className={tailwind('block h-9 w-full rounded-full border border-gray-400 bg-white pl-4 pr-6 text-sm text-gray-700 placeholder:text-gray-500 focus:border-gray-400 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50 blk:border-gray-600 blk:bg-gray-700 blk:text-gray-100 blk:placeholder:text-gray-400 blk:focus:border-transparent')} placeholder="Password" value={passwordInputValue} id="password-input" name="password-input" autoCapitalize="none" type={doShowPassword ? 'text' : 'password'}></input>
