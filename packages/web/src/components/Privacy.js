    ...
    return (
      <React.Fragment>
        ...
        <div className="mx-auto px-4 pt-16 pb-4 w-full max-w-3xl bg-white text-gray-500 md:px-6 lg:px-8">
          ...
          <h2 className="pt-8 text-xl text-gray-900 font-semibold">Cookies and Local Storage</h2>
          <p className="pt-3 leading-7">We do not use "Cookies". We use local storage provided by your browser to store your preferences which is considered safer and more privacy friendly. The purpose is to display personalized content, enrich and perfect your online experience.</p>
          ...
          <p className="pt-5 leading-7">By continuing to navigate our website without changing your browser's local storage settings, you hereby acknowledge and agree to our use of local storage.</p>

          <h2 className="pt-8 text-xl text-gray-900 font-semibold">Data Retention</h2>
          <p className="pt-3 leading-7">To determine the appropriate retention period for your personal information, we consider the amount, nature, and sensitivity of the personal information, the potential risk of harm from unauthorized use or disclosure of your personal information, the purposes for which we use your personal information and whether we can achieve those purposes through other means, and the applicable legal requirements. In certain circumstances, we can anonymize your personal information, subject to applicable law.</p>
          <p className="pt-5 leading-7">The personally identifiable information we collect right now is your user ID and your purchase history which is only collected if you purchase a paid subscription because we need it to unlock additional features of our services to your account. We keep your user ID and your purchase history for as long as reasonably necessary i.e. as your subscription is valid and not expired or as required by law (for example, for legal, tax, accounting or other purposes).</p>
          <p className="pt-5 leading-7">If you have supplied your email address to us, we retain your email address until you opt out of receiving our email communications.</p>
          <p className="pt-5 leading-7">If you'd like to get your data on our servers, or to permanently delete your data, please contact us and we will take care of it for you as quickly as possible.</p>

          <h2 className="pt-8 text-xl text-gray-900 font-semibold">Data Transfers</h2>
          <p className="pt-3 leading-7">Your data is stored on our servers hosted by Google Cloud Platform located in the United States. We may also store information on servers and equipment in other countries depending on a variety of factors, including the locations of our users and service providers. These data transfers allow us to provide our services to you. By accessing or using our services or otherwise providing information to us, you understand that your information will be processed, transferred, and stored in the U.S. and other countries, where different data protection standards may apply and/or you may not have the same rights as you do under local law.</p>

          <h2 className="pt-8 text-xl text-gray-900 font-semibold">Privacy Policy Changes</h2>
          <p className="pt-3 leading-7">Although most changes are likely to be minor, we may change our Privacy Policy from time to time, and in our sole discretion. We encourage you to frequently check this page for any changes to its Privacy Policy. Your continued use of our services after any change in this Privacy Policy will constitute your acceptance of such change.</p>

          <p className="pt-5 leading-7">Your continued use of our services will be regarded as acceptance of our privacy policy. If you have any questions about this Privacy Policy, please contact us at <a className="text-gray-900 font-medium underline rounded-sm focus:outline-none focus:ring" href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#64;&#98;&#114;&#97;&#99;&#101;&#46;&#116;&#111;"><span className="e-mail" data-user="troppus" data-website="ot.ecarb"></span></a>. Alternatively, you may contact us at:</p>
          <p className="pt-3 leading-7">STX Apps Co., Ltd.<br />ATTN: Brace.to Team<br />247 Chan 31 Sathon<br />Bangkok 10120 TH</p>
