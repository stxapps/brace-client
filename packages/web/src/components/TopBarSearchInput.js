  ...
  render() {
    ...
    return (
      <div className="relative ml-4 w-48">
        ...
        <input onChange={this.onSearchInputChange} className="ml-0.5 py-1.5 pl-9 pr-6 block w-full bg-gray-100 text-sm text-gray-700 border border-transparent rounded-full placeholder-gray-500 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50 focus:bg-white focus:border-gray-200 focus:placeholder-gray-400" type="search" placeholder="Search" value={searchString} autoCapitalize="none" />
