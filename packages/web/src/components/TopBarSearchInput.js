    ...
    return (
      <div className={tailwind('relative ml-4 w-48')}>
        <div className={tailwind('absolute inset-y-0 left-0 flex items-center pl-3')}>
          <svg className={tailwind('h-5 w-5 text-gray-400')} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.32 14.9l1.1 1.1c.4-.02.83.13 1.14.44l3 3a1.5 1.5 0 0 1-2.12 2.12l-3-3a1.5 1.5 0 0 1-.44-1.14l-1.1-1.1a8 8 0 1 1 1.41-1.41l.01-.01zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" />
          </svg>
        </div>
        <input onChange={this.onSearchInputChange} className={tailwind('ml-0.5 block w-full rounded-full border border-transparent bg-gray-100 py-1.5 pl-9 pr-6 text-sm text-gray-700 placeholder-gray-500 focus:border-gray-200 focus:bg-white focus:placeholder-gray-400 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50')} type="search" placeholder="Search" value={searchString} autoCapitalize="none" />
