  ...
  render() {
    ...
    return (
      <div className="relative ml-4 w-48 lg:w-56">
        ...
        <input onChange={this.onSearchInputChange} className="py-1 pl-10 pr-6 form-input block w-full bg-gray-300 text-gray-900 border border-transparent rounded-full placeholder-gray-600 appearance-none hover:shadow-outline focus:outline-none focus:shadow-outline focus:bg-white focus:border-gray-300" type="search" placeholder="Search" value={searchString} autoCapitalize="none" />
