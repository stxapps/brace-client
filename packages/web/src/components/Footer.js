  ...
  render() {
    ...
    return (
      <footer className={tailwind('mx-auto max-w-6xl px-4 pt-28 pb-6 md:px-6 lg:px-8')}>
        <div className={tailwind('text-left md:text-center')}>
        ...
        <div className={tailwind('flex items-center justify-start pt-6 md:justify-center')}>
          ...
          <a className={tailwind('ml-6 rounded focus:outline-none focus:ring')} href="https://github.com/stxapps/brace-client" target="_blank" rel="noreferrer">
