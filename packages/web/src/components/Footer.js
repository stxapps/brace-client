    ...
    return (
      <footer className="mx-auto px-4 pt-28 pb-6 max-w-6xl md:px-6 lg:px-8">
        <div className="text-left md:text-center">
          <a className="block text-base text-gray-700 focus:outline-none focus:shadow-outline md:inline md:mr-4" href="/#about">About</a>
          <a className="mt-4 block text-base text-gray-700 focus:outline-none focus:shadow-outline md:inline md:mt-0 md:mr-4" href="/#terms">Terms of use</a>
          <a className="mt-4 block text-base text-gray-700 focus:outline-none focus:shadow-outline md:inline md:mt-0 md:mr-4" href="/#privacy">Privacy</a>
          <a className="mt-4 block text-base text-gray-700 focus:outline-none focus:shadow-outline md:inline md:mt-0" href="/#support">Support</a>
        </div>
        <div className="pt-6 flex justify-start items-center md:justify-center">
          <a className="focus:outline-none focus:shadow-outline" href="https://twitter.com/bracedotto">
            <svg className="w-8 text-gray-500" viewBox="0 0 40 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a className="ml-4 rounded-full focus:outline-none focus:shadow-outline" href="https://github.com/bracedotto/brace-client/issues">
            <svg className="w-8 text-gray-500" viewBox="0 0 33 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
