              ...
              <li>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1.5 text-lg text-gray-700">You found a long, useful, and important article you can't read it right now? Not a problem. Just save to Brace.to to read it later.</p>
                  </div>
                </div>
              </li>
              <li className="mt-10 md:mt-0">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1.5 text-lg text-gray-700">You found a ridiculously cool and interesting website you want to check it out later? Not a problem. Just save to Brace.to to visit it later.</p>
                  </div>
                </div>
              </li>
              <li className="mt-10 md:mt-0">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1.5 text-lg text-gray-700">You found an item on online shop you don’t want it now but might want to buy it later? Not a problem. Just save to Brace.to.</p>
                  </div>
                </div>
              </li>
              <li className="mt-10 md:mt-0">
          ...
          <div className="bg-gray-900">
            <div className="mx-auto relative max-w-6xl">
              ...
              <div className="pt-16 px-4 md:px-6 lg:px-8">
                ...
                <p className="mt-2 text-base text-gray-400 font-normal leading-normal md:text-center lg:text-lg">Every link you saved will be beautified with its representative image and title <br className="hidden md:inline" />so that you can easily find it and recognize it.</p>
          ...
          <div className="mt-12 block md:flex md:flex-row md:justify-between xl:mt-20">
            <div className="w-full md:w-1/3">
              <div style={{ borderRadius: '0.75rem' }} className="p-4 bg-gray-100 md:mr-2 md:h-full lg:mr-3 lg:max-w-md xl:mr-4">
                ...
                <h4 className="mt-8 text-xl text-gray-800 font-medium leading-snug">No ban on your owned identity</h4>
            ...
            <div className="w-full md:w-1/3">
              <div style={{ borderRadius: '0.75rem' }} className="mt-8 p-4 bg-gray-100 md:mt-0 md:ml-2 md:h-full lg:ml-3 lg:max-w-md xl:ml-4">
                <svg className="h-14" width="78" height="78" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="39" cy="39" r="39" fill="#211F6D" />
                ...
                <h3 className="mt-4 text-2xl text-gray-800 font-semibold leading-none">Encryption</h3>
                <p className="mt-3 text-lg text-gray-700 font-normal leading-normal">Everything is encrypted  and only you with your secret key can see the content inside.</p>
                <h4 className="mt-8 text-xl text-gray-800 font-medium leading-snug">No targeted ads and No data breach risk</h4>
                <p className="mt-3 text-lg text-gray-700 font-normal leading-normal">As no one can see the content inside your data, your data cannot be used to make targeted ads on you. Also, there is no risk, if your data is stolen.</p>
              </div>
            </div>
          </div>
        </section >
