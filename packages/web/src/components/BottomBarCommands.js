          ...
          <div className={tailwind('h-full w-full p-1')}>
            <button onClick={this.onAddBtnClick} className={tailwind('group flex h-full w-full flex-col items-center justify-center rounded focus:outline-none focus:ring')}>
              <div className={tailwind('flex h-6 w-6 items-center justify-center')}>
                <svg style={{ width: '1.125rem' }} className={tailwind('mb-0.5 text-gray-500 group-hover:text-gray-600')} viewBox="0 0 13 12" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.5 1V10.4286M1 5.67609H12" strokeWidth="1.57143" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div className={tailwind('mt-0.5 text-xs leading-4 text-gray-500 group-hover:text-gray-600')}>Add</div>
            </button>
          </div>
          <div className={tailwind('h-full w-full p-1')}>
            <button onClick={this.onSearchBtnClick} className={tailwind('group flex h-full w-full flex-col items-center justify-center rounded focus:outline-none focus:ring')}>
              <div className={tailwind('flex h-6 w-6 items-center justify-center')}>
                <svg style={{ width: '1.375rem' }} className={tailwind('text-gray-500 group-hover:text-gray-600')} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.32 14.9l1.1 1.1c.4-.02.83.13 1.14.44l3 3a1.5 1.5 0 0 1-2.12 2.12l-3-3a1.5 1.5 0 0 1-.44-1.14l-1.1-1.1a8 8 0 1 1 1.41-1.41l.01-.01zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" />
                </svg>
              </div>
              <div className={tailwind('mt-0.5 text-xs leading-4 text-gray-500 group-hover:text-gray-600')}>Search</div>
            </button>
          </div>
          <div className={tailwind('h-full w-full p-1')}>
            <button onClick={this.onBulkEditBtnClick} className={tailwind('group flex h-full w-full flex-col items-center justify-center rounded focus:outline-none focus:ring')}>
              <div className={tailwind('flex h-6 w-6 items-center justify-center')}>
                <svg className={tailwind('h-5 w-5 text-gray-500 group-hover:text-gray-600')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className={tailwind('mt-0.5 text-xs leading-4 text-gray-500 group-hover:text-gray-600')}>Select</div>
            </button>
          </div>
          <div className={tailwind('h-full w-full p-1')}>
            <button onClick={this.onProfileBtnClick} className={tailwind('group flex h-full w-full flex-col items-center justify-center rounded focus:outline-none focus:ring')}>
              <div className={tailwind('flex h-6 w-6 items-center justify-center')}>
                <svg className={tailwind('mt-1 h-6 w-6 text-gray-500 group-hover:text-gray-600')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className={tailwind('mt-0.5 text-xs leading-4 text-gray-500 group-hover:text-gray-600')}>More</div>
            </button>
          </div>
        </div>
      </React.Fragment>
