          ...
          <div className="p-1 w-full h-full">
            <button onClick={this.onAddBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg style={{ width: '1.125rem', marginBottom: '0.125rem' }} className="text-gray-400 group-hover:text-gray-500" viewBox="0 0 13 12" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.5 1V10.4286M1 5.67609H12" strokeWidth="1.57143" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div style={{ marginTop: '0.125rem' }} className="text-xs text-gray-500 leading-4 group-hover:text-gray-600">Add</div>
            </button>
          </div>
          <div className="p-1 w-full h-full">
            <button onClick={this.onSearchBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg style={{ width: '1.375rem' }} className="text-gray-400 group-hover:text-gray-500" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.32 14.9l1.1 1.1c.4-.02.83.13 1.14.44l3 3a1.5 1.5 0 0 1-2.12 2.12l-3-3a1.5 1.5 0 0 1-.44-1.14l-1.1-1.1a8 8 0 1 1 1.41-1.41l.01-.01zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" />
                </svg>
              </div>
              <div style={{ marginTop: '0.125rem' }} className="text-xs text-gray-500 leading-4 group-hover:text-gray-600">Search</div>
            </button>
          </div>
          <div className="p-1 w-full h-full">
            <button onClick={this.onBulkEditBtnClick} className="flex flex-col justify-center items-center w-full h-full rounded group focus:outline-none focus:ring">
              <div className="flex justify-center items-center w-6 h-6">
                <svg style={{ width: '1.25rem' }} className="text-gray-400 group-hover:text-gray-500" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div style={{ marginTop: '0.125rem' }} className="text-xs text-gray-500 leading-4 group-hover:text-gray-600">Select</div>
            </button>
          </div>
