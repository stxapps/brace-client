    ...
    return (
      <div className="p-4 md:p-6 md:pt-4">
        ...
        <div className="mt-6 md:mt-0">
          ...
          <p className="mt-2.5 text-base text-gray-500 leading-relaxed">Brace.to stores your data in a Stacks data server. You can specify which Stacks data server to store your data. By default, your Stacks data server is at <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring" href="https://hub.blockstack.org/hub_info">hub.blockstack.org</a> provided by <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring" href="https://www.hiro.so">Hiro Systems</a>. You can also deploy your own Stacks data server. To change your Stacks data server, you need to record your server’s information to Stacks blockchain. Brace.to stores your data to the server specified in the blockchain. For more details, please visit <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring" href="https://docs.stacks.co/build-apps/references/gaia">Stacks Gaia</a> and <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring" href="https://docs.stacks.co/storage-hubs/overview">Stacks Gaia Hubs</a>.</p>
        </div>
        <div className="mt-8">
    ...
    if (!exportAllDataProgress) {
      ...
      actionPanel = (
        <div className="mt-6 mb-4">
          ...
          <p className="mt-6 text-base text-gray-500 leading-relaxed">Please wait a moment and try again. If the problem persists, please <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring" href="/#support">contact us
    ...
    return (
      <div className="p-4 md:p-6 md:pt-4">
        ...
        <div className="mt-6 flex items-center">
          <input onChange={this.onConfirmInputChange} checked={this.state.didCheckConfirm} className="w-4 h-4 text-blue-500 border-gray-400 rounded transition duration-150 ease-in-out focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50 focus:border-gray-400" id="confirm-input" type="checkbox" />
