...
class BottomBarSearchPopup extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <motion.div className={tailwind('fixed inset-x-0 bottom-0 z-10 flex items-center justify-between border-t border-gray-200 bg-white px-2 py-2 blk:border-gray-700 blk:bg-gray-800')} variants={bbSearchPopupFMV} initial={false} animate={this.animate}>
