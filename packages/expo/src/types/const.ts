...
export const APP_GROUP_SHARE_PKEY = 'pKey';
...
export const LIST_NAMES_MODE_CHANGE_TAG_NAME = 'LIST_NAMES_MODE_CHANGE_TAG_NAME';
...
export const LIST_NAMES_MODE_ADD_LINK = 'LIST_NAMES_MODE_ADD_LINK';
...
export const BULK_EDIT_MENU_ANIM_TYPE_POPUP = 'BULK_EDIT_MENU_ANIM_TYPE_POPUP';
export const BULK_EDIT_MENU_ANIM_TYPE_BMODAL = 'BULK_EDIT_MENU_ANIM_TYPE_BMODAL';

export const NOT_SUPPORTED = 'NOT_SUPPORTED';

export const ADD_MODE_BASIC = 'ADD_MODE_BASIC';
export const ADD_MODE_ADVANCED = 'ADD_MODE_ADVANCED';
