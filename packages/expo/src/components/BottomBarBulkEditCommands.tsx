...
class BottomBarBulkEditCommands extends React.Component<any, any> {
        ...
        <View style={cache('BBBEC_innerBulkEdit', [tailwind('w-full flex-row justify-evenly'), { height: toPx(BOTTOM_BAR_HEIGHT) }], [tailwind])}>
          ...
          {isMoreBtnShown && <View style={tailwind('flex-1 p-1')}>
            <TouchableOpacity ref={this.moreBtn} onPress={this.onBulkEditMoreBtnClick} style={tailwind('h-full w-full items-center justify-center')}>
              ...
              <Text style={tailwind('mt-0.5 w-full text-center text-xs font-normal leading-4 text-gray-500 blk:text-gray-400')} numberOfLines={1} ellipsizeMode="tail">More actions</Text>
            </TouchableOpacity>
          </View>}
          <View style={tailwind('flex-1 p-1')}>
            <TouchableOpacity onPress={this.onBulkEditCancelBtnClick} style={tailwind('h-full w-full items-center justify-center')}>
              <View style={tailwind('items-center justify-center')}>
                <Svg style={tailwind('font-normal text-gray-500 blk:text-gray-400')} width={24} height={24} viewBox="0 0 28 28" fill="currentColor">
