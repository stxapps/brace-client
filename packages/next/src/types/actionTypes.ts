...
export const UPDATE_DEFAULT_ADD_LINK_MODE = 'UPDATE_DEFAULT_ADD_LINK_MODE';
export const UPDATE_LOCAL_ADD_LINK_DEFAULT_MODE = 'UPDATE_LOCAL_ADD_LINK_DEFAULT_MODE';
