...
import {
  INCREASE_REDIRECT_TO_MAIN_COUNT, UPDATE_LIST_NAME, UPDATE_QUERY_STRING,
  UPDATE_SEARCH_STRING, UPDATE_POPUP, FETCH, FETCH_COMMIT, FETCH_ROLLBACK,
  UPDATE_FETCHED, FETCH_MORE_ROLLBACK, UPDATE_FETCHED_MORE, REFRESH_FETCHED,
  ADD_FETCHING_INFO, DELETE_FETCHING_INFO, SET_SHOWING_LINK_IDS, ADD_LINKS,
  MOVE_LINKS_ADD_STEP, DELETE_LINKS_COMMIT, CANCEL_DIED_LINKS,
...
const displayReducer = (state = initialState, action) => {
  ...
  if (action.type === UPDATE_POPUP) {
    ...
    if (id === SWWU_POPUP) {
      return { ...state, isSWWUPopupShown: isShown };
    }
