...
const SettingsPopupConflict = (props) => {
  ...
  return (
    <React.Fragment>
      <div className={tailwind('relative mx-auto min-h-144 max-w-3xl px-4 pb-4 md:px-6 md:pb-6 lg:px-8 lg:pb-8')}>
    ...
    <div className={tailwind('mt-6 rounded-lg border border-gray-200 blk:border-gray-700')}>
      <div className={tailwind(`rounded-t-lg bg-gray-50 blk:bg-gray-800 sm:flex sm:items-center sm:justify-between ${!isOpen ? 'rounded-b-lg' : ''}`)}>
        ...
        <div className={tailwind('py-3 pl-2.5 sm:flex-shrink-0 sm:flex-grow-0 sm:pl-6 sm:pr-4')}>
          <button onClick={onChooseBtnClick} style={{ height: '2.125rem', paddingLeft: '0.625rem', paddingRight: '0.75rem' }} className={tailwind('inline-flex items-center rounded-full border border-gray-300 bg-white text-sm text-gray-500 hover:border-gray-400 hover:text-gray-600 focus:outline-none focus:ring blk:border-gray-500 blk:bg-gray-800 blk:text-gray-300 blk:hover:border-gray-400 blk:hover:text-gray-200')} type="button">
