  ...
  return (
    <div className={tailwind('p-4 md:p-6')}>
      <div className={tailwind('border-b border-gray-200 blk:border-gray-700 md:hidden')}>
        ...
        <h3 className={tailwind('pb-2 text-xl font-medium leading-none text-gray-800 blk:text-gray-100')}>Lists</h3>
      </div>
      <div className={tailwind('hidden md:block')}>
        <h4 className={tailwind('text-base font-medium leading-none text-gray-800 blk:text-gray-100')}>Lists</h4>
      </div>
    ...
    if (listNameObj && listNameObj.children && listNameObj.children.length > 0) {
      ...
      expandBtn = (
        <button onClick={onExpandBtnClick} className={tailwind('group flex h-10 w-8 flex-shrink-0 flex-grow-0 items-center justify-start focus:outline-none')}>
          <div className={tailwind('flex h-3.5 w-3.5 items-center justify-center rounded-xs text-gray-500 group-hover:text-gray-600 group-focus:ring group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')}>
            {expandSvg}
          </div>
        </button>
      );
    ...
    <React.Fragment>
      <div style={viewStyle} className={tailwind('mt-1 flex items-center justify-start')}>
        ...
        {state.mode === MODE_EDIT && <button onTouchStart={onCancelBtnPress} onMouseDown={onCancelBtnPress} onClick={onCancelBtnClick} className={tailwind('group flex h-10 w-8 flex-shrink-0 flex-grow-0 items-center justify-start focus:outline-none')}>
          <svg className={tailwind('h-3 w-3 rounded-xs text-gray-500 group-hover:text-gray-600 group-focus:ring group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 12 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={tailwind('relative flex-shrink flex-grow')}>
          <input ref={input} onFocus={onInputFocus} onBlur={onInputBlur} onChange={onInputChange} onKeyDown={onInputKeyPress} className={tailwind('w-full border-0 bg-transparent px-0 py-2 text-base text-gray-600 placeholder:text-gray-500 focus:outline-none focus:ring-0 blk:text-gray-300 blk:placeholder:text-gray-400')} type="text" placeholder="Create a new list" value={state.value} disabled={isBusy} />
        ...
        {state.mode === MODE_EDIT && <button onTouchStart={onOkBtnPress} onMouseDown={onOkBtnPress} onClick={onOkBtnClick} className={tailwind('group flex h-10 w-10 flex-shrink-0 flex-grow-0 items-center justify-center focus:outline-none')}>
          <svg className={tailwind('w-4 rounded-xs text-gray-500 group-hover:text-gray-600 group-focus:ring group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 14 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {(state.mode === MODE_VIEW && listNameObj !== null) && <button onClick={onEditBtnClick} className={tailwind('group hidden h-10 w-10 flex-shrink-0 flex-grow-0 items-center justify-center focus:outline-none sm:flex')} disabled={isBusy} title="Edit">
          <svg className={tailwind('w-4 rounded-xs text-gray-500 group-hover:text-gray-600 group-focus:ring group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 14 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {(state.mode === MODE_VIEW && listNameObj !== null) && <button onClick={onMoveUpBtnClick} className={tailwind('group hidden h-10 w-10 flex-shrink-0 flex-grow-0 items-center justify-center focus:outline-none lg:flex')} disabled={isBusy} title="Move up">
          <svg className={tailwind('h-4 rounded-xs text-gray-500 group-hover:text-gray-600 group-focus:ring group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 14 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
