      ...
      <motion.div style={style} className={tailwind('fixed inset-x-0 bottom-0 z-10 bg-white blk:bg-gray-800')} variants={bbSearchPopupFMV} initial={false} animate={this.animate}>
        <div className={tailwind('flex items-center justify-between border-t border-gray-200 px-2 py-2 blk:border-gray-700')}>
          <div className={tailwind('relative w-full')}>
            <input ref={this.searchInput} onChange={this.onSearchInputChange} className={tailwind('w-full flex-shrink flex-grow rounded-full border border-gray-400 bg-white py-1.5 pl-4 pr-6 text-sm text-gray-700 placeholder:text-gray-500 focus:border-gray-200 focus:outline-none focus:ring focus:ring-blue-500/50 blk:border-gray-600 blk:bg-gray-800 blk:text-gray-200 blk:placeholder:text-gray-400 blk:focus:border-transparent')} type="search" placeholder="Search" value={searchString} autoCapitalize="none" />
