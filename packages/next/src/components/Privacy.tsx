...
class Privacy extends React.PureComponent<any, any> {
      ...
      <React.Fragment>
        ...
        <div className={tailwind('mx-auto w-full max-w-6xl bg-white')}>
          <div className={tailwind('mx-auto w-full max-w-3xl bg-white px-4 pt-16 pb-4 text-gray-500 md:px-6 lg:px-8')}>
            ...
            <p className={tailwind('pt-3 leading-7')}>To determine the appropriate retention period for your personal information, we consider the amount, nature, and sensitivity of the personal information, the potential risk of harm from unauthorized use or disclosure of your personal information, the purposes for which we use your personal information and whether we can achieve those purposes through other means, and the applicable legal requirements. We can anonymize your personal information in certain circumstances, subject to applicable law.</p>
            <p className={tailwind('pt-5 leading-7')}>The personally identifiable information we collect is your user ID and purchase history. It is only collected if you purchase a paid subscription because we need it to unlock extra features of our services to your account. We keep your user ID and purchase history for as long as reasonably necessary, i.e., as long as your subscription is valid, not expired, or as required by law (for legal, tax, accounting, or other purposes).</p>
            ...
            <p className={tailwind('pt-5 leading-7')}>If you&apos;d like to get your data on our servers or permanently delete it, please contact us, and we will take care of it for you as quickly as possible.</p>

            <h2 className={tailwind('pt-8 text-xl font-semibold text-gray-900')}>Data Transfers</h2>
            <p className={tailwind('pt-3 leading-7')}>Your data is stored on our servers hosted by Google Cloud Platform in the United States. We may also store information on servers and equipment in other countries depending on various factors, including our users&apos; and service providers&apos; locations. These data transfers allow us to provide our services to you. By accessing or using our services or otherwise providing information to us, you understand that your information will be processed, transferred, and stored in the U.S. and other countries, where different data protection standards may apply and/or you may not have the same rights as you do under local law.</p>
