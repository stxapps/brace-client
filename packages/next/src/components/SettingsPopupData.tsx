...
export const SettingsPopupData = connect(mapStateToProps)(withTailwind(InnerSettingsPopupData));
...
class InnerSettingsPopupDataExport extends React.PureComponent<any, any> {
...
export const SettingsPopupDataExport = connect(mapStateToPropsExport, mapDispatchToPropsExport)(withTailwind(InnerSettingsPopupDataExport));

class InnerSettingsPopupDataDelete extends React.PureComponent<any, any> {
    ...
    return (
      <div className={tailwind('p-4 md:p-6 md:pt-4')}>
        ...
        <div className={tailwind('mt-6 flex items-center')}>
          <input onChange={this.onConfirmInputChange} checked={this.state.didCheckConfirm} className={tailwind('h-4 w-4 cursor-pointer rounded border-gray-400 text-blue-500 transition duration-150 ease-in-out focus:border-gray-400 focus:outline-none focus:ring focus:ring-blue-500/50 blk:border-gray-400 blk:bg-gray-900 blk:checked:bg-blue-600 blk:focus:ring-offset-gray-900')} id="confirm-input" name="confirm-input" type="checkbox" />
...
export const SettingsPopupDataDelete = connect(mapStateToPropsDelete, mapDispatchToPropsDelete)(withTailwind(InnerSettingsPopupDataDelete));
