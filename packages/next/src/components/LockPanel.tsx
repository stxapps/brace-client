...
const LockPanel = (props) => {
  ...
  return (
    <div className={tailwind('fixed inset-0 overflow-y-auto bg-white blk:bg-gray-900')}>
      <div style={canvasStyle}>
        <div style={style} className={tailwind('mx-auto max-w-6xl px-4 md:px-6 lg:px-8')}>
          <div className={tailwind('py-6 md:py-10')}>
            <button onClick={onLockBtnClick} className={tailwind('group mx-auto block w-full max-w-sm py-6 focus:outline-none')}>
