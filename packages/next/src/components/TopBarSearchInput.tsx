  ...
  render() {
    ...
    return (
      <div className={tailwind('relative ml-4 w-48')}>
        ...
        <input onChange={this.onSearchInputChange} className={tailwind('ml-0.5 block w-full rounded-full border border-transparent bg-gray-100 py-1.5 pl-9 pr-6 text-sm text-gray-700 placeholder:text-gray-500 focus:border-gray-200 focus:bg-white focus:outline-none focus:ring focus:ring-blue-500/50 focus:placeholder:text-gray-500 blk:bg-gray-800 blk:text-gray-200 blk:placeholder:text-gray-400 blk:focus:border-transparent blk:focus:bg-gray-800 blk:focus:placeholder:text-gray-400')} type="search" placeholder="Search" value={searchString} autoCapitalize="none" />
