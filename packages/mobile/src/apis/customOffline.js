...
import {
  ...
  PIN_LINK, UNPIN_LINK, UPDATE_CUSTOM_DATA, UPDATE_TAG_DATA_S_STEP,
...
export const effect = async (effectObj, _action) => {
  ...
  if ([
    FETCH, FETCH_MORE, ADD_LINKS, UPDATE_LINKS, MOVE_LINKS_ADD_STEP, DELETE_LINKS,
    EXTRACT_CONTENTS, TRY_UPDATE_SETTINGS, UPDATE_SETTINGS, TRY_UPDATE_INFO,
    UPDATE_INFO, PIN_LINK, UNPIN_LINK, UPDATE_CUSTOM_DATA, UPDATE_TAG_DATA_S_STEP,
    UPDATE_TAG_DATA_T_STEP,
  ].includes(method)) {
