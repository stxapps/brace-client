        ...
        <ScrollView style={{ maxHeight: panelHeight }} keyboardShouldPersistTaps="handled">
          <View style={tailwind('px-4 pt-8 pb-4 sm:px-6 sm:pb-6')}>
            ...
            <View style={tailwind(`flex-row items-center justify-start ${tagEditor.msg ? '' : 'pt-5'}`)}>
              ...
              <TouchableOpacity onPress={onAddBtnClick} style={[tailwind('ml-2 flex-row flex-shrink-0 flex-grow-0 items-center rounded-full border border-gray-400 bg-white pl-1.5 pr-2.5 blk:border-gray-400 blk:bg-gray-800'), { paddingVertical: 5 }]}>
