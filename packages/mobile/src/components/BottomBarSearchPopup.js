  ...
  render() {
    ...
    return (
      <Animated.View style={[tailwind('px-2 py-2 absolute inset-x-0 flex-row justify-between items-center bg-white border-t border-gray-200 z-10'), style]}>
        ...
        <TouchableOpacity onPress={this.onSearchCancelBtnClick} style={tailwind('ml-2 px-1.5 py-1 flex-grow-0 flex-shrink-0 justify-center items-center h-10 rounded-md')}>
