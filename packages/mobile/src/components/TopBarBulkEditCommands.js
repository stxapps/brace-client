        ...
        <View style={tailwind('mx-4 mb-3 p-4 max-w-sm bg-red-100 rounded-md')}>
          <View style={tailwind('flex-row w-full')}>
            ...
            <View style={tailwind('ml-3 flex-shrink flex-grow')}>
              <Text style={tailwind('text-sm leading-5 font-medium text-red-800 text-left')}>Please select item(s) below first before continuing.</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={tailwind('flex-row justify-end items-center')}>
        {isArchiveBtnShown && <View style={tailwind('ml-4')}>
          <TouchableOpacity onPress={this.onBulkEditArchiveBtnClick}>
            <View style={[tailwind('flex-row justify-center items-center bg-white border border-gray-700 rounded-full shadow-sm'), btnStyle]}>
              ...
              <Text style={tailwind('ml-1 text-base text-gray-700')}>Archive</Text>
            </View>
          </TouchableOpacity>
        </View>}
        {isRemoveBtnShown && <View style={tailwind('ml-4')}>
          <TouchableOpacity onPress={this.onBulkEditRemoveBtnClick}>
            <View style={[tailwind('flex-row justify-center items-center bg-white border border-gray-700 rounded-full shadow-sm'), btnStyle]}>
              ...
              <Text style={tailwind('ml-1 text-base text-gray-700')}>Remove</Text>
            </View>
          </TouchableOpacity>
        </View>}
        {isRestoreBtnShown && <View style={tailwind('ml-4')}>
          <TouchableOpacity onPress={this.onBulkEditRestoreBtnClick}>
            <View style={[tailwind('flex-row justify-center items-center bg-white border border-gray-700 rounded-full shadow-sm'), btnStyle]}>
              ...
              <Text style={tailwind('ml-1 text-base text-gray-700')}>Restore</Text>
            </View>
          </TouchableOpacity>
        </View>}
        {isDeleteBtnShown && <View style={tailwind('ml-4')}>
          <TouchableOpacity onPress={this.onBulkEditDeleteBtnClick}>
            <View style={[tailwind('flex-row justify-center items-center bg-white border border-gray-700 rounded-full shadow-sm'), btnStyle]}>
              ...
              <Text style={tailwind('ml-1 text-base text-gray-700')}>Permanently Delete</Text>
            </View>
          </TouchableOpacity>
        </View>}
        {isMoveToBtnShown && <Menu renderer={renderers.Popover} rendererProps={{ preferredPlacement: 'bottom', anchorStyle: tailwind(anchorClasses) }} onOpen={this.onBulkEditMoveToBtnClick} onClose={this.onBulkEditMoveToCancelBtnClick}>
          <MenuTrigger>
            <View style={tailwind('ml-4')}>
              <View style={[tailwind('flex-row justify-center items-center bg-white border border-gray-700 rounded-full shadow-sm'), btnStyle]}>
                ...
                <Text style={tailwind('ml-1 text-base text-gray-700')}>Move to...</Text>
              </View>
            </View>
          </MenuTrigger>
        ...
        <TouchableOpacity onPress={this.onBulkEditCancelBtnClick} style={tailwind('ml-1 justify-center items-center w-10 h-10')}>
          <Svg style={tailwind('text-gray-600 rounded-full')} width={28} height={28} viewBox="0 0 28 28" fill="currentColor">
