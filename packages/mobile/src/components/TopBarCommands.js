    ...
    return (
      <View style={tailwind('flex-row justify-end items-center')}>
        ...
        <TouchableOpacity onPress={this.onBulkEditBtnClick} style={tailwind('ml-4')}>
          <View style={cache('TBC_bulkEditBtnView', [tailwind('px-3 py-1 flex-row justify-center items-center bg-white border border-gray-600 rounded-full shadow-sm'), { height: 32, paddingLeft: 10, paddingRight: 12 }])}>
