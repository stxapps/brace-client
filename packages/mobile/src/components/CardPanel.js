  ...
  renderEmpty = () => {
    ...
    if (listName === MY_LIST) {
      return (
        <View style={tailwind('px-4 pb-6 items-center w-full md:px-6 lg:px-8', safeAreaWidth)}>
          <View style={cache('CP_emptyMyListView', [tailwind('pt-16 pb-8 items-center w-full max-w-md bg-gray-100'), BORDER_RADIUS])}>
            ...
            <Text style={tailwind('mt-16 max-w-md text-lg text-gray-900 font-normal text-center')}>Or type <Text style={tailwind('text-lg text-gray-900 font-semibold')}>"brace.to/"</Text> in front of any link {safeAreaWidth > 390 ? '\n' : ''}in Address bar.</Text>
    ...
    if (listName === TRASH) {
      return (
        <View style={tailwind('px-4 pb-6 items-center w-full md:px-6 lg:px-8', safeAreaWidth)}>
          ...
          <Text style={tailwind('mt-6 text-lg text-gray-900 font-normal text-center')}>No links in Trash</Text>
          <Text style={tailwind('mt-4 max-w-md text-base text-gray-900 font-normal text-center')}>Click <Text style={tailwind('text-base text-gray-900 font-semibold')}>"Remove"</Text> from the Link menu to move links you don't need anymore to the Trash.</Text>
        </View>
      );
    }
    ...
    return (
      <View style={tailwind('px-4 pb-6 items-center w-full md:px-6 lg:px-8', safeAreaWidth)}>
        ...
        <Text style={tailwind('mt-4 max-w-md text-base text-gray-900 font-normal text-center')}>Click <Text style={tailwind('text-base text-gray-900 font-semibold')}>"{displayName}"</Text> from the Link menu to move links here.</Text>
      </View>
    );
  }
