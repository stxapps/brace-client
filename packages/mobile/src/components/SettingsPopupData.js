    ...
    return (
      <View style={tailwind('p-4 md:p-6 md:pt-4', safeAreaWidth)}>
        ...
        <View style={tailwind('mt-6 md:mt-0', safeAreaWidth)}>
          ...
          <Text style={tailwind('mt-2 text-base text-gray-700 font-normal leading-6.5')}>With your Blockstack identity, you can have your own data server called Gaia to store all your data from apps you use with your Blockstack identity. You just need to specify your server’s information in Blockstack blockchain. Brace.to stores all your data in the server specified in the blockchain. For more details, please visit <Text onPress={() => Linking.openURL('https://docs.blockstack.org/data-storage/overview')} style={tailwind('text-base text-gray-700 font-normal underline')}>Blockstack Gaia</Text> and <Text onPress={() => Linking.openURL('https://docs.blockstack.org/storage-hubs/overview')} style={tailwind('text-base text-gray-700 font-normal underline')}>Blockstack Gaia hubs</Text>.</Text>
        </View>
        <View style={tailwind('mt-8')}>
          <Text style={tailwind('text-xl text-gray-800 font-medium leading-5')}>Export All Data</Text>
          <Text style={tailwind('mt-2 text-base text-gray-700 font-normal leading-6.5')}>Export all your data from server to your device in a text file. Please go to <Text onPress={() => Linking.openURL('https://brace.to')} style={tailwind('text-base text-gray-700 font-normal underline')}>Brace.to</Text> to take the action.</Text>
        </View>
        <View style={tailwind('mt-8 mb-4')}>
          ...
          <Text style={tailwind('mt-2 text-base text-gray-700 font-normal leading-6.5')}>Delete all your data including but not limited to all your saved links in all lists, all your created lists, and all your settings.</Text>
        </View>
      </View>
    );
  }
  ...
  render() {
    ...
    if (!exportAllDataProgress) {
      actionPanel = (
        <TouchableOpacity onPress={this.onExportAllDataBtnClick} style={tailwind('mt-6 mb-4 justify-start items-start')}>
          <Text style={tailwind('px-4 py-2 bg-white text-base text-gray-700 font-normal border border-gray-700 rounded-full shadow')}>Export All My Data</Text>
        </TouchableOpacity>
      );
      ...
      actionPanel = (
        <View style={tailwind('mt-6 mb-4')}>
          <View style={tailwind('flex-row items-center')}>
            ...
            <Text style={tailwind('ml-1 text-base text-red-700 font-normal')}>Oops..., something went wrong!</Text>
          </View>
          <Text style={tailwind('text-base text-red-700 font-normal leading-6.5')}>{exportAllDataProgress.error}</Text>
          <Text style={tailwind('mt-6 text-base text-gray-700 font-normal leading-6.5')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL('https://brace.to/#support')} style={tailwind('text-base text-gray-700 font-normal underline')}>contact us</Text>
            <Svg style={tailwind('mb-2 text-base text-gray-700 font-normal')} width={16} height={16} viewBox="0 0 20 20" fill="currentColor">
      ...
      actionPanel = (
        <View style={tailwind('mt-6 mb-4')}>
          <View style={tailwind('flex-row items-center')}>
            ...
            <Text style={tailwind('ml-1 text-base text-gray-800 font-normal')}>No data to export.</Text>
          </View>
          <Text style={tailwind('text-base text-gray-800 font-normal')}>{exportAllDataProgress.done} / {exportAllDataProgress.total}</Text>
        </View>
      );
      ...
      actionPanel = (
        <View style={tailwind('mt-6 mb-4')}>
          <View style={tailwind('flex-row items-center')}>
            <Svg style={tailwind('text-base text-green-500 font-normal')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
            ...
            <Text style={tailwind('ml-1 text-base text-gray-800 font-normal')}>Done</Text>
          </View>
          <Text style={tailwind('text-base text-gray-800 font-normal')}>{exportAllDataProgress.done} / {exportAllDataProgress.total}</Text>
        </View>
      );
      ...
      actionPanel = (
        <View style={tailwind('mt-6 mb-4')}>
          <View style={tailwind('flex-row items-center')}>
            ...
            <Text style={tailwind('ml-1 text-base text-gray-800 font-normal')}>Exporting...</Text>
          </View>
          <Text style={tailwind('text-base text-gray-800 font-normal')}>{exportAllDataProgress.done} / {exportAllDataProgress.total}</Text>
        </View>
      );
    ...
    return (
      <View style={tailwind('p-4 md:p-6 md:pt-4', safeAreaWidth)}>
        ...
        <Text style={tailwind('mt-6 text-base text-gray-700 font-normal leading-6.5')}>Export all your data from server to your device in a text file.</Text>
        <Text style={tailwind('mt-6 text-base text-gray-700 font-normal leading-6.5')}>It may take several minutes to export all your data.</Text>
        {actionPanel}
      </View>
    );
  }
  ...
  render() {
    ...
    if (!deleteAllDataProgress) {
      ...
      actionPanel = (
        <View style={tailwind('mt-6 mb-4')}>
          ...
          <Text style={tailwind('text-base text-red-700 font-normal leading-6.5')}>{deleteAllDataProgress.error}</Text>
          <Text style={tailwind('mt-6 text-base text-gray-700 font-normal leading-6.5')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL('https://brace.to/#support')} style={tailwind('text-base text-gray-700 font-normal underline')}>contact us</Text>
            <Svg style={tailwind('mb-2 text-base text-gray-700 font-normal')} width={16} height={16} viewBox="0 0 20 20" fill="currentColor">
              <Path d="M11 3C10.4477 3 10 3.44772 10 4C10 4.55228 10.4477 5 11 5H13.5858L7.29289 11.2929C6.90237 11.6834 6.90237 12.3166 7.29289 12.7071C7.68342 13.0976 8.31658 13.0976 8.70711 12.7071L15 6.41421V9C15 9.55228 15.4477 10 16 10C16.5523 10 17 9.55228 17 9V4C17 3.44772 16.5523 3 16 3H11Z" />
              <Path d="M5 5C3.89543 5 3 5.89543 3 7V15C3 16.1046 3.89543 17 5 17H13C14.1046 17 15 16.1046 15 15V12C15 11.4477 14.5523 11 14 11C13.4477 11 13 11.4477 13 12V15H5V7H8C8.55228 7 9 6.55228 9 6C9 5.44772 8.55228 5 8 5H5Z" />
      ...
      actionPanel = (
        <View style={tailwind('mt-6 mb-4')}>
          <View style={tailwind('flex-row items-center')}>
            ...
            <Text style={tailwind('ml-1 text-base text-gray-800 font-normal')}>No data to delete.</Text>
          </View>
          <Text style={tailwind('text-base text-gray-800 font-normal')}>{deleteAllDataProgress.done} / {deleteAllDataProgress.total}</Text>
        </View>
      );
      ...
      actionPanel = (
        <View style={tailwind('mt-6 mb-4')}>
          <View style={tailwind('flex-row items-center')}>
            <Circle size={20} color="#2D3748" />
            <Text style={tailwind('ml-1 text-base text-gray-800 font-normal')}>Deleting...</Text>
          </View>
          <Text style={tailwind('text-base text-gray-800 font-normal')}>{deleteAllDataProgress.done} / {deleteAllDataProgress.total}</Text>
        </View>
      );
    ...
    return (
      <View style={tailwind('p-4 md:p-6 md:pt-4', safeAreaWidth)}>
        ...
        <Text style={tailwind('mt-6 text-base text-gray-700 font-normal leading-6.5')}>Delete all your data including but not limited to all your saved links in all lists, all your created lists, and all your settings.</Text>
        <Text style={tailwind('mt-6 text-base text-gray-700 font-normal leading-6.5')}>This will only remove all your data, not your account. You will still be able to sign in.</Text>
