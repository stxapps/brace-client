  ...
  renderAdding() {
    ...
    const content = (
      <React.Fragment>
        ...
        <Text style={tailwind('mt-5 w-full max-w-xs text-base text-gray-800 font-normal text-center')} numberOfLines={4} ellipsizeMode="tail">{uText}</Text>
  ...
  renderDiedAdding() {
    ...
    const content = (
      <React.Fragment>
        ...
        <Text style={tailwind('mt-5 w-full max-w-xs text-base text-gray-900 font-normal text-center')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL('https://brace.to/#support')} style={tailwind('text-base text-gray-900 font-normal')}>contact us</Text>
          <Svg style={tailwind('mb-2 text-base text-gray-900 font-normal')} width={16} height={16} viewBox="0 0 20 20" fill="currentColor">
        ...
        <TouchableOpacity onPress={() => this.onReceivedHref(this.props.href)} style={tailwind('mt-5 mb-px justify-center items-center h-14')}>
          <View style={tailwind('px-4 py-2 justify-center items-center bg-white border border-gray-900 rounded-full shadow-sm')}>
            <Text style={tailwind('text-base text-gray-900 font-normal')}>Try again</Text>
          </View>
        </TouchableOpacity>
        {this.renderNav()}
      </React.Fragment>
  ...
  renderAskingConfirm(addingUrl) {
    ...
    const content = (
      <React.Fragment>
        ...
        <Text style={tailwind('mt-5 w-full max-w-xs text-base text-gray-800 font-normal text-center')} numberOfLines={4} ellipsizeMode="tail">{addingUrl}</Text>
  ...
  renderNotSignedIn() {
    ...
    const content = (
      <React.Fragment>
        ...
        <Text style={tailwind('mt-10 w-full max-w-xs text-base text-gray-900 font-normal text-center')}>
          No account yet?{'  '}
          <Text onPress={() => this.props.signUp()} style={tailwind('text-base text-gray-900 font-normal underline')}>Sign up</Text>
        </Text>
        {this.renderNav()}
      </React.Fragment>
    );
