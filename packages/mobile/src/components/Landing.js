    ...
    return (
      <Swiper height={swiperHeight} showsPagination={true} showsButtons={false} activeDotStyle={tailwind('bg-gray-900')} paginationStyle={{ bottom: 10 }} loop={false}>
        ...
        <View style={tailwind('px-4 justify-center items-center w-full h-full md:px-6 lg:px-8', windowWidth)}>
          ...
          <Text style={tailwind('mt-3 text-lg text-gray-700 text-center leading-7')}>A lot of interesting, useful, and important stuff are {windowWidth >= SM_WIDTH && windowWidth < MD_WIDTH ? '\n' : ''}out there on the internet. {windowWidth >= MD_WIDTH ? '\n' : ''}Brace.to helps you save them so that you will never miss anything.</Text>
        </View>
        <View style={tailwind('px-4 justify-center items-center w-full h-full md:px-6 lg:px-8', windowWidth)}>
          <View style={tailwind('flex-row max-w-md')}>
            ...
            <View style={tailwind('ml-4 flex-shrink flex-grow')}>
              ...
              <Text style={tailwind('mt-1.5 text-lg text-gray-700 leading-7')}>You found an interesting, long, useful article you can't read it right now? Just save to Brace.to to read it later.</Text>
            </View>
          </View>
          <View style={tailwind('mt-8 flex-row max-w-md md:mt-12', windowWidth)}>
            ...
            <View style={tailwind('ml-4 flex-shrink flex-grow')}>
              ...
              <Text style={tailwind('mt-1.5 text-lg text-gray-700 leading-7')}>You found an interesting websites you want to check it out later? Just save to Brace.to to visit them later.</Text>
            </View>
          </View>
        </View>
        <View style={tailwind('px-4 justify-center items-center w-full h-full md:px-6 lg:px-8', windowWidth)}>
          <View style={tailwind('flex-row max-w-md')}>
            ...
            <View style={tailwind('ml-4 flex-shrink flex-grow')}>
              ...
              <Text style={tailwind('mt-1.5 text-lg text-gray-700 leading-7')}>You found an item on online shop you don’t want them now but might want to buy them later? Just save to Brace.to.</Text>
            </View>
          </View>
          <View style={tailwind('mt-8 flex-row max-w-md md:mt-12', windowWidth)}>
            <View style={tailwind('flex-shrink-0 flex-grow-0')}>
        ...
        <View style={tailwind('px-4 justify-center items-center w-full h-full md:px-6 lg:px-8', windowWidth)}>
          <View style={[tailwind('p-4 bg-gray-100 max-w-sm'), borderRadius]}>
            ...
            <Text style={tailwind('mt-3 text-lg text-gray-700 font-normal leading-7')}>Your identity <Text style={tailwind('text-lg text-gray-700 font-semibold')}>cannot</Text> be locked, banned, or deleted by Brace.to or anyone. Your identity lives in blockchain. Only you with your password can access it and control it.</Text>
          </View>
        </View>
        <View style={tailwind('px-4 justify-center items-center w-full h-full md:px-6 lg:px-8', windowWidth)}>
          <View style={[tailwind('p-4 bg-gray-100 max-w-sm'), borderRadius]}>
