    ...
    return (
      <Swiper height={swiperHeight} showsPagination={true} showsButtons={false} activeDotStyle={tailwind('bg-gray-500')} paginationStyle={cache('L_pagination', { bottom: 10 })} loop={false}>
        ...
        <View style={tailwind('h-full w-full items-center justify-center px-4 md:px-6 lg:px-8')}>
          ...
          <Text style={tailwind('mt-4 text-center text-3xl font-semibold text-gray-900 md:text-4xl')}>Your privacy at heart powered by <Text style={tailwind('text-3xl font-semibold text-purple-blockstack md:text-4xl')}>Stacks</Text></Text>
          <Text style={tailwind('mt-4 text-center text-lg font-normal text-gray-500 md:text-xl')}>Your identity is truly yours. {safeAreaWidth >= SM_WIDTH ? '' : '\n'}Your data is truly yours.</Text>
        </View>
        <View style={tailwind('h-full w-full items-center justify-center px-4 md:px-6 lg:px-8')}>
          <View style={cache('L_blockstackGrayBox', [tailwind('max-w-sm bg-gray-50 p-4'), borderRadius])}>
            ...
            <Text style={tailwind('mt-5 text-xl font-semibold leading-5 text-gray-900 md:text-2xl')}>Identity</Text>
            <Text style={tailwind('mt-2.5 text-base font-normal text-gray-500 md:text-lg')}>Your identity lives in blockchain and only you with your secret key can access it and control it.</Text>
            <Text style={tailwind('mt-5 text-base font-medium text-gray-900 md:text-lg leading-5.5')}>No ban on your owned identity</Text>
            <Text style={tailwind('mt-2.5 text-base font-normal text-gray-500 md:text-lg')}>Your identity cannot be locked, banned, or deleted by anyone as your secret key is required.</Text>
          </View>
        </View>
        <View style={tailwind('h-full w-full items-center justify-center px-4 md:px-6 lg:px-8')}>
          <View style={cache('L_blockstackGrayBox', [tailwind('max-w-sm bg-gray-50 p-4'), borderRadius])}>
            ...
            <Text style={tailwind('mt-5 text-base font-medium text-gray-900 md:text-lg leading-5.5')}>No lock out from your own data</Text>
        ...
        <View style={tailwind('h-full w-full items-center justify-center px-4 md:px-6 lg:px-8')}>
          <View style={cache('L_blockstackGrayBox', [tailwind('max-w-sm bg-gray-50 p-4'), borderRadius])}>
            ...
            <Text style={tailwind('mt-5 text-base font-medium text-gray-900 md:text-lg leading-5.5')}>No targeted ads and No data breach risk</Text>
        ...
        <View style={tailwind('h-full w-full items-center justify-center bg-purple-blockstack px-4 md:px-6 lg:px-8')}>
          ...
          <Text style={tailwind('mt-20 text-center text-lg font-normal leading-6 text-gray-200 md:text-xl')}>Not just that Brace.to don't be evil, Brace.to can't be evil.</Text>
        </View>
      </Swiper >
    );
  }
