...
const LockPanel = (props) => {
  ...
  return (
    <ScrollView>
      <View style={[tailwind('items-center max-w-6xl self-center px-4 md:px-6 lg:px-8'), style]}>
        <TouchableOpacity onPress={onLockBtnClick} style={tailwind('my-6 w-full max-w-sm items-center')}>
          ...
          <View style={tailwind('mt-4 items-center justify-center')}>
            <View style={[tailwind('flex-row items-center justify-center rounded-full border border-gray-400 bg-white shadow-sm blk:border-gray-400 blk:bg-gray-900'), { height: 32, paddingLeft: 10, paddingRight: 12 }]}>
              ...
              <Text style={tailwind('ml-1 text-sm font-normal text-gray-500 leading-3.5 blk:text-gray-300')}>Unlock</Text>
            </View>
          </View>
        </TouchableOpacity>
      </View>
