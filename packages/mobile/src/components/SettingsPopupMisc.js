...
class SettingsPopupMisc extends React.PureComponent {
  ...
  renderUpdateSettingsProgress() {
    ...
    if (updateSettingsProgress.status === DIED_UPDATING) {
      return (
        <View style={tailwind('absolute top-10 inset-x-0 flex-row justify-center items-start md:top-0', safeAreaWidth)}>
          <View style={tailwind('w-full max-w-md')}>
            <View style={tailwind('m-4 p-4 bg-red-50 rounded-md shadow-lg')}>
              <View style={tailwind('flex-row')}>
                ...
                <View style={tailwind('pl-3 flex-grow-0 flex-shrink-0')}>
