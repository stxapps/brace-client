...
const SettingsListsMenuPopup = () => {
  ...
  const buttons = (
    <View style={tailwind('py-1')}>
      <TouchableOpacity onPress={onEditBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3')}>
        <Svg style={tailwind('mr-3 text-gray-400 font-normal')} width={20} height={20} viewBox="0 0 14 14" fill="currentColor">
      ...
      <TouchableOpacity onPress={onMoveUpBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3')}>
        <Svg style={tailwind('mr-3 text-gray-400 font-normal')} width={18} height={20} viewBox="0 0 14 16" fill="currentColor">
      ...
      <TouchableOpacity onPress={onMoveDownBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3')}>
        <Svg style={tailwind('mr-3 text-gray-400 font-normal')} width={18} height={20} viewBox="0 0 14 16" fill="currentColor">
      ...
      <TouchableOpacity onPress={onMoveToBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3')}>
        <Svg style={tailwind('mr-3 text-gray-400 font-normal')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
