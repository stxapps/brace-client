  ...
  const buttons = (
    <View style={tailwind('py-1')}>
      <TouchableOpacity onPress={onEditBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3 sm:hidden')}>
        <Svg style={tailwind('mr-3 font-normal text-gray-400')} width={16} height={16} viewBox="0 0 14 14" fill="currentColor">
        ...
        <Text style={tailwind('text-sm font-normal text-gray-700')} numberOfLines={1} ellipsizeMode="tail">Edit</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={onMoveUpBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3 lg:hidden')}>
        <Svg style={tailwind('mr-3 font-normal text-gray-400')} width={16} height={18} viewBox="0 0 14 16" fill="currentColor">
        ...
        <Text style={tailwind('text-sm font-normal text-gray-700')} numberOfLines={1} ellipsizeMode="tail">Move up</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={onMoveDownBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3 lg:hidden')}>
        ...
        <Text style={tailwind('text-sm font-normal text-gray-700')} numberOfLines={1} ellipsizeMode="tail">Move down</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={onMoveToBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3')}>
        <Svg style={tailwind('mr-3 font-normal text-gray-400')} width={16} height={12} viewBox="0 0 16 12" fill="currentColor">
        ...
        <Text style={tailwind('text-sm font-normal text-gray-700')} numberOfLines={1} ellipsizeMode="tail">Move to</Text>
      </TouchableOpacity>
      {![MY_LIST, TRASH, ARCHIVE].includes(selectingListName) && <TouchableOpacity onPress={onDeleteBtnClick} style={tailwind('w-full flex-row items-center px-4 py-3')}>
        ...
        <Text style={tailwind('text-sm font-normal text-gray-700')} numberOfLines={1} ellipsizeMode="tail">Delete</Text>
      </TouchableOpacity>}
    </View>
  );

  let popupClassNames = 'absolute w-36 rounded-lg border border-gray-100 bg-white shadow-xl';
  let panel;
