...
class BottomBarCommands extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <View style={cache('BBC_innerStyle', [tailwind('relative w-full flex-row justify-evenly overflow-hidden'), { height: toPx(BOTTOM_BAR_HEIGHT) }])}>
          <View style={tailwind('flex-1 p-1')}>
            <TouchableOpacity onPress={this.onAddBtnClick} style={tailwind('h-full w-full items-center justify-center')}>
              <View style={tailwind('h-6 w-6 items-center justify-center')}>
                <Svg style={tailwind('mb-0.5 font-normal text-gray-500')} width={18} height={17} viewBox="0 0 13 12" stroke="currentColor">
                  <Path d="M6.5 1V10.4286M1 5.67609H12" strokeWidth="1.57143" strokeLinecap="round" strokeLinejoin="round" />
                </Svg>
              </View>
              <Text style={tailwind('mt-0.5 text-xs font-normal leading-4 text-gray-500')}>Add</Text>
            </TouchableOpacity>
          </View>
          <View style={tailwind('flex-1 p-1')}>
            <TouchableOpacity onPress={this.onSearchBtnClick} style={tailwind('h-full w-full items-center justify-center')}>
              <View style={tailwind('h-6 w-6 items-center justify-center')}>
                <Svg style={tailwind('font-normal text-gray-500')} width={22} height={22} viewBox="0 0 24 24" fill="currentColor">
                  <Path d="M16.32 14.9l1.1 1.1c.4-.02.83.13 1.14.44l3 3a1.5 1.5 0 0 1-2.12 2.12l-3-3a1.5 1.5 0 0 1-.44-1.14l-1.1-1.1a8 8 0 1 1 1.41-1.41l.01-.01zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" />
                </Svg>
              </View>
              <Text style={tailwind('mt-0.5 text-xs font-normal leading-4 text-gray-500')}>Search</Text>
            </TouchableOpacity>
          </View>
          <View style={tailwind('flex-1 p-1')}>
            <TouchableOpacity onPress={this.onBulkEditBtnClick} style={tailwind('h-full w-full items-center justify-center')}>
              ...
              <Text style={tailwind('mt-0.5 text-xs font-normal leading-4 text-gray-500')}>Select</Text>
            </TouchableOpacity>
          </View>
          <View style={tailwind('flex-1 p-1')}>
            <TouchableOpacity onPress={this.onProfileBtnClick} style={tailwind('h-full w-full items-center justify-center')}>
              <View style={tailwind('h-6 w-6 items-center justify-center')}>
                <Svg style={tailwind('mt-1 font-normal text-gray-500')} width={24} height={24} viewBox="0 0 20 20" fill="currentColor">
              ...
              <Text style={tailwind('mt-0.5 text-xs font-normal leading-4 text-gray-500')}>More</Text>
            </TouchableOpacity>
          </View>
        </View>
      </React.Fragment>
