    ...
    return (
      <View style={tailwind('p-4 md:p-6', safeAreaWidth)}>
        ...
        <View style={tailwind('mt-6 md:mt-0', safeAreaWidth)}>
          ...
          <Text style={tailwind('mt-4 text-base text-gray-500 font-normal leading-6.5')}>Your Secret Key is a password that is only known to you. If you lose it, there is no way to retrieve it back. You need to keep it safe.</Text>
          <Text style={tailwind('mt-4 text-base text-gray-500 font-normal leading-6.5')}>Your Secret Key cannot be changed or reset. As your Secret Key is used to encrypt your data, each file individually, if you change your Secret Key, every file needs to be decrypted with your old Secret Key and encrypted again with your new Secret Key.</Text>
        </View>
        <View style={tailwind('mt-8 mb-4')}>
          ...
          <Text style={tailwind('mt-4 text-base text-gray-500 font-normal leading-6.5')}>If you get started with us, currently we create your Stacks account without username, profile, and data server location. So there is no data stored in Stacks blockchain and your data server is automatically selected.</Text>
          <Text style={tailwind('mt-4 text-base text-gray-500 font-normal leading-6.5')}>After you delete all your data in Settings -&gt; Data -&gt; Delete All Data, there's nothing left. You can just forget your Secret Key. It's permanently deleting your account.</Text>
        </View>
      </View>
    );
  }
