...
const ListItem = (props) => {
  ...
  const renderBusy = () => {
    ...
    return (
      <View style={tailwind('absolute top-0 right-0 h-10 w-10 overflow-hidden bg-transparent')}>
        <View style={[tailwind('h-10 w-10 overflow-hidden bg-gray-600'), triangleStyle]}>
          <Svg style={[tailwind('font-normal text-gray-100'), svgStyle]} width={16} height={16} viewBox="0 0 24 24" fill="currentColor">
  ...
  const renderPin = () => {
    ...
    return (
      <View style={tailwind('absolute top-0 left-0 h-10 w-10 overflow-hidden bg-transparent')}>
        <View style={[tailwind('h-10 w-10 overflow-hidden bg-gray-600'), triangleStyle]}>
          <Svg style={[tailwind('font-normal text-gray-100'), svgStyle]} width={12} height={12} viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <View style={tailwind('border-b border-gray-200 bg-white')}>
