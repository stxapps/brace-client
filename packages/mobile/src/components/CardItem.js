...
class CardItem extends React.Component {
  ...
  renderBusy() {
    ...
    return (
      <View style={tailwind('absolute top-0 right-0 h-16 w-16 overflow-hidden rounded-tr-lg bg-transparent')}>
        <View style={cache('CI_busyTriangle', [tailwind('h-16 w-16 overflow-hidden bg-white'), triangleStyle])}>
          <Svg style={cache('CI_busySvg', [tailwind('h-6 w-6 font-normal text-gray-700'), svgStyle])} viewBox="0 0 24 24" fill="currentColor">
  ...
  renderPinning() {
    ...
    return (
      <View style={tailwind('absolute top-0 left-0 h-16 w-16 overflow-hidden rounded-tl-lg bg-transparent')}>
        <View style={cache('CI_pinningTriangle', [tailwind('h-16 w-16 overflow-hidden bg-white'), triangleStyle])}>
          <Svg style={cache('CI_pinningSvg', [tailwind('h-6 w-6 font-normal text-gray-700'), svgStyle])} viewBox="0 0 24 24" fill="currentColor">
            <Path d="M19.479 10.092C19.267 6.141 16.006 3 12 3s-7.267 3.141-7.479 7.092A5.499 5.499 0 005.5 21h13a5.499 5.499 0 00.979-10.908zM18.5 19h-13C3.57 19 2 17.43 2 15.5c0-2.797 2.479-3.833 4.433-3.72C6.266 7.562 8.641 5 12 5c3.453 0 5.891 2.797 5.567 6.78 1.745-.046 4.433.751 4.433 3.72 0 1.93-1.57 3.5-3.5 3.5zm-4.151-2h-2.77l3-3h2.77l-3 3zm-4.697-3h2.806l-3 3H6.652l3-3zM20 15.5a1.5 1.5 0 01-1.5 1.5h-2.03l2.788-2.788c.442.261.742.737.742 1.288zm-16 0A1.5 1.5 0 015.5 14h2.031l-2.788 2.788A1.495 1.495 0 014 15.5z" />
          </Svg>
        </View>
      </View>
  ...
  renderPin() {
    ...
    return (
      <View style={tailwind('absolute top-0 left-0 h-16 w-16 overflow-hidden rounded-tl-lg bg-transparent')}>
        <View style={cache('CI_pinTriangle', [tailwind('h-16 w-16 overflow-hidden bg-white'), triangleStyle])}>
          <Svg style={cache('CI_pinSvg', [tailwind('font-normal text-gray-500'), svgStyle])} width={16} height={16} viewBox="0 0 24 24" fill="currentColor">
  ...
  render() {
    ...
    return (
      <View style={style}>
        <View style={tailwind(`self-center rounded-lg bg-white ${viewStyle}`)}>
