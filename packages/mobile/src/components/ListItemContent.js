  ...
  return (
    <View style={tailwind('flex-row items-center')}>
      ...
      <View style={tailwind('flex-grow-0 flex-shrink-0 flex-row justify-end items-center -mr-3 sm:-mr-1', safeAreaWidth)}>
        {(safeAreaWidth >= LG_WIDTH && ![ARCHIVE, TRASH].includes(listName) && ![ADDING, MOVING].includes(link.status)) && <TouchableOpacity onPress={onArchiveBtnClick} style={tailwind('px-2.5 py-3.5')}>
        ...
        {(safeAreaWidth >= LG_WIDTH && listName !== TRASH && ![ADDING, MOVING].includes(link.status)) && <TouchableOpacity onPress={onRemoveBtnClick} style={tailwind('px-2.5 py-3.5')}>
          <Svg style={tailwind('text-gray-400 font-normal')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
        ...
        {(safeAreaWidth >= LG_WIDTH && listName === TRASH && ![ADDING, MOVING].includes(link.status)) && <TouchableOpacity onPress={onRestoreBtnClick} style={tailwind('px-2.5 py-3.5')}>
          <Svg style={tailwind('text-gray-400 font-normal')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
