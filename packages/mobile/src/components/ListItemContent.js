...
import {
  DOMAIN_NAME, COLOR, PATTERN, IMAGE, ARCHIVE, TRASH, LG_WIDTH,
} from '../types/const';
import {
  ...
  return (
    <View style={tailwind('flex-row items-center')}>
      ...
      <View style={tailwind('flex-grow-0 flex-shrink-0 flex-row justify-end items-center -mr-3 sm:-mr-1', safeAreaWidth)}>
        {safeAreaWidth >= LG_WIDTH && <TouchableOpacity onPress={onArchiveBtnClick} style={tailwind('px-2.5 py-3.5')}>
          <Svg style={tailwind('w-5 h-5 text-gray-400 font-normal')} viewBox="0 0 20 20" fill="currentColor">
        ...
        {safeAreaWidth >= LG_WIDTH && <TouchableOpacity onPress={onRemoveBtnClick} style={tailwind('px-2.5 py-3.5')}>
          <Svg style={tailwind('w-5 h-5 text-gray-400 font-normal')} viewBox="0 0 20 20" fill="currentColor">
