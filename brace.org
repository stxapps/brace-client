...
*** Puppeteer
** stack user
- blossom brand lounge toast divorce wool catalog sleep floor odor there advance
- law story ensure butter aspect wasp state cherry number spy knock gym
- melody use spot old hub tool become motion defense plastic spike clean
- mosquito oxygen bronze sure couple trust husband join illness reject promote swallow
** steps
...
- yarn add @redux-offline/redux-offline
- yarn add blockstack @blockstack/connect
...
- yarn remove @redux-offline/redux-offline
...
- yarn add reselect url-parse axios jdenticon
- yarn add @react-native-community/async-storage @react-native-community/netinfo
- yarn add 'https://gitpkg.now.sh/bracedotto/blockstack-react-native/BlockstackSDK?5662e3d96ac9d927443b623ddb271aa5e434c3ac'
...
- yarn add https://github.com/bracedotto/tailwind-rn#f00e5de8b2b16fdbfbea2c7d14d5e52c9b52844b
...
- ios
  + Edit PodFile: ios target 11.0, pad 'Blockstack'
  + Add RNBlockstackSdk to Bracedotto project with Xcode, select create groups
  + In Xcode, Bracedotto General -> Target iOS 11.0
  + Make swift file can import obj-c header
    ~ In Build Settings -> Swift Compiler - General -> Objective-C Bridging Header: ../node_modules/react-native-blockstack/ios/RNBlockstackSdk/RNBlockstackSdk-Bridging-Header.h
