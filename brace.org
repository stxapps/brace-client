...
- yarn add https://github.com/bracedotto/redux-offline#4969cde61cd97a9f317f158cade8c96374871a6d
...
- yarn add url-parse axios @react-native-community/clipboard
- yarn add https://github.com/bracedotto/redux-offline#4969cde61cd97a9f317f158cade8c96374871a6d
- yarn add @react-native-community/async-storage @react-native-community/netinfo
- yarn add 'https://gitpkg.now.sh/bracedotto/blockstack-react-native/BlockstackSDK?a2aacea2fe4e384b6dbb51de05e343fe0f4602d6'
- yarn add https://github.com/bracedotto/tailwind-rn#96848a8d2c2370e4f5e57a773ace172c4073157d
...
- yarn add https://github.com/bracedotto/react-native-receive-sharing-intent#4306f9ee6a94c849c3b1a3ec4e4217054fb999c6
...
- yarn add react-native-iap @wewatch/lexorank
...
- startup script in Custom metadata, key: startup-script, value:
  #! /bin/bash
  sudo -u linux bash -c 'cd /home/linux/brace-server-worker; mkdir -p ./logs; NOW=$(date +'%Y%m%d%H%M%S'); /home/linux/.nvm/versions/node/v16.16.0/bin/node --experimental-specifier-resolution=node src/index.js > "./logs/log_${NOW}.txt" 2>&1; sudo shutdown -h now'
...
- assume unchanged: git update-index --assume-unchanged src/appstore-keys.json src/playstore-service-account.json
